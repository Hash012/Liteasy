...
const localRoot = path.join(repositoryRoot, "deploy/local");
...
export function verifyStaticFoundation() {
  ...
  for (const script of [
    "deploy/local/postgres/postgres-entrypoint.sh",
    "deploy/local/postgres/init-product-database.sh",
    "deploy/local/keycloak/configure-keycloak.sh"
  ]) {

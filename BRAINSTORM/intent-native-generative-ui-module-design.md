...
[5] Ruichao Mao, Zhou Fang, Teng Guo, Hao Yang, Yaping Li, Shaohua Peng, Maji Huang, Xiaoyu Lin, Shuoyang Liu, Xuepeng Li, Yuyu Zhang, Hai Rao. *Reasoning for Mobile User Experience with Multimodal LLMs: Task, Benchmark, and Approach*. arXiv:2606.13192, 2026. Local file: `BRAINSTORM/reference/reasoning-for-mobile-user-experience-with-multimodal-llms-2606.13192.pdf`.  

[6] `BRAINSTORM/reference/reading-notes.md`. Local research notes on Generative UI, Intent-Driven UI, Agentic UI, UXBench, and implementation implications.  

[7] `BRAINSTORM/mature-intent-native-generative-ui-build-guide1.md`. Current architecture guide and build manual for Intent-Native Generative UI.

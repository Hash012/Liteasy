...
const unitPatterns: readonly {
  ...
  { pattern: /^\s*(?:ns|纳秒)\b/i, unit: unit("time", 1n, 1_000_000_000n) },
  { pattern: /^\s*(?:us|μs|µs|微秒)\b/i, unit: unit("time", 1n, 1_000_000n) },
  { pattern: /^\s*(?:ms|毫秒)\b/i, unit: unit("time", 1n, 1000n) },
  { pattern: /^\s*(?:s|sec(?:ond)?s?|秒)\b/i, unit: unit("time") },
  { pattern: /^\s*(?:min(?:ute)?s?|分钟)\b/i, unit: unit("time", 60n) },
  { pattern: /^\s*(?:h|hours?|小时)\b/i, unit: unit("time", 3600n) },
  ...
  { pattern: /^\s*(?:bytes?|字节)\b/i, unit: unit("bytes") },

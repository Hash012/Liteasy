...
**Tech Stack:** Existing `Tauri 2`, `React`, `TypeScript`, `Rust`, current `services/dev-cloud` Node service, plus incremental formalization of resource typing, deployability, and platform boundaries.

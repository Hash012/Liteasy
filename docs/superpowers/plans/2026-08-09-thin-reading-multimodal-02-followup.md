...
- [x] **Step 3: Add the lifecycle migration contract**
...
- [x] **Step 4: Implement server-owned provisioning and gate**
...
- [x] **Step 1: Write failing concurrency and failure tests**
...
- [x] **Step 3: Implement finalization in the repository**
...
- [x] **Step 4: Finalize every service path**
...
- [x] **Step 1: Write failing identity and cancellation tests**
...
- [x] **Step 3: Make invocation identity authoritative**
...
- [x] **Step 4: Preserve cost and enforce response caps**
...
- [x] Run API, admin, and desktop focused tests plus builds.
- [x] Run `git diff --check` and verify only intended files are committed; preserve existing dirty thin-reading/export files.
- [x] Generate a scoped review package from the follow-up base to the final head and obtain spec/quality approval before continuing Plan 03.

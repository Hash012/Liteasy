...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/organization/organizationSummaryClient.ts`
- Test: `products/liteasy/apps/desktop/src/tests/organizationSummaryClient.test.ts`
...
Add `products/liteasy/apps/desktop/src/tests/organizationSummaryClient.test.ts`:
...
Run: `cd products/liteasy/apps/desktop && npm test -- src/tests/organizationSummaryClient.test.ts`

Expected: FAIL because `organizationSummaryClient` does not exist.

- [x] **Step 3: Add the cloud endpoint failing test**

Add a `returns a demo organization summary` test to `development/dev-cloud/server.test.mjs` that posts `{ "sessionId": "demo-session-1" }` to `/v1/org/summary` and expects the same fields shown in Step 1.

- [x] **Step 4: Run the cloud endpoint test to verify it fails**

Run: `node --test development/dev-cloud/server.test.mjs`

Expected: FAIL with `/v1/org/summary` returning `not_found`.

- [x] **Step 5: Implement the minimal desktop client and endpoint**

Create the organization types and client, then add `buildOrganizationSummaryPayload()` plus a `POST /v1/org/summary` branch in `development/dev-cloud/server.mjs`.
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/organizationSummaryClient.test.ts
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSpacePanel.tsx`
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationSummary.ts`
...
Run: `cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "shows organization space summary after cloud account login"`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/organizationSummaryClient.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSpacePanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/organizationSummaryClient.test.ts`
- Modify: `development/dev-cloud/server.mjs`
- Modify: `development/dev-cloud/server.test.mjs`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/organizationSummaryClient.test.ts src/tests/AppShell.test.tsx -t "organization space summary|opens the organization shared library|posts a session id"
node --test development/dev-cloud/server.test.mjs
```
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/organizationSummaryClient.test.ts src/tests/AppShell.test.tsx -t "members and notification|organization space summary|posts a session id"
```
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/organizationGovernanceClient.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationGovernance.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationGovernancePanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Test: `products/liteasy/apps/desktop/src/tests/organizationGovernanceClient.test.ts`
- Test: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `development/dev-cloud/server.mjs`
- Modify: `development/dev-cloud/server.test.mjs`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/organizationGovernanceClient.test.ts src/tests/AppShell.test.tsx -t "governance summary"
node --test development/dev-cloud/server.test.mjs
```
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/organizationListClient.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationList.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/organizationSummaryClient.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationSummary.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSpacePanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Test: `products/liteasy/apps/desktop/src/tests/organizationListClient.test.ts`
- Test: `products/liteasy/apps/desktop/src/tests/organizationSummaryClient.test.ts`
- Test: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `development/dev-cloud/server.mjs`
- Modify: `development/dev-cloud/server.test.mjs`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/organizationListClient.test.ts src/tests/organizationSummaryClient.test.ts src/tests/organizationGovernanceClient.test.ts src/tests/AppShell.test.tsx -t "organization|组织|governance|共享"
node --test --test-name-pattern "demo organization list|organization-specific governance|demo organization summary|demo organization governance" development/dev-cloud/server.test.mjs
```
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/commandRouter.ts`
...
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Test: `products/liteasy/apps/desktop/src/tests/commandRouter.test.ts`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/commandRouter.test.ts src/tests/actionRegistry.test.ts src/tests/AppShell.test.tsx -t "organization shared|打开组织共享|registered assistant command"
```
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationEntryDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Test: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "organization|组织|governance|共享|entry dialog"
```
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Test: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "personal center|organization entry dialog|organization|组织"
```
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/profile/AcademicArchiveDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Test: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "personal center|academic archive|organization entry dialog|organization|组织"
```
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/profile/ClearProfileConfirmDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Test: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "personal center|academic archive|clearing the user profile|organization entry dialog|organization|组织"
```
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/organizationSummaryClient.test.ts src/tests/AppShell.test.tsx
node --test development/dev-cloud/server.test.mjs
```
...
Run: `node --test development/dev-cloud/server.test.mjs development/dev-cloud/providers/openaiResponses.test.mjs`
...
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/organizationNotificationStorage.ts`
- Create: `products/liteasy/apps/desktop/src/tests/organizationNotificationStorage.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/models/usePolicySync.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/qa/phase3-test-guide.md`
- Modify: `docs/qa/phase3-governance-limitations.md`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/organizationNotificationStorage.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/organizationNotificationStorage.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/qa/phase3-test-guide.md`
- Modify: `docs/qa/phase3-governance-limitations.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationInviteConfirmDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationLeaveConfirmDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/qa/phase3-test-guide.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationCreateDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationJoinDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/qa/phase3-test-guide.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationActions.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useOrganizationActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationNotifications.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useOrganizationNotifications.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationWorkspace.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useOrganizationWorkspace.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/profile/useProfileActions.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useProfileActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/useLeftRailNavigation.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useLeftRailNavigation.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationUiState.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useOrganizationUiState.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationData.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useOrganizationData.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/collection/useCollectionItems.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useCollectionItems.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/models/useModelSettingsActions.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useModelSettingsActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/workspace/useWorkspaceActions.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useWorkspaceActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/artifacts/useArtifactActions.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useArtifactActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/workspace/useWorkspaceActions.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/workspace/useRegisteredWorkspaceActions.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useRegisteredWorkspaceActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/account/useCloudAccountActions.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useCloudAccountActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/starterPapers.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/workspace/workspaceStateHelpers.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/settings/settingsStateHelpers.ts`
- Create: `products/liteasy/apps/desktop/src/tests/appShellStateHelpers.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/ActivityBar.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/ActivityBar.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `products/liteasy/apps/desktop/src/tests/useWorkspaceActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/useArtifactActions.test.ts`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/AppBrand.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/AppBrand.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/SettingsPane.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/SettingsPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/TopBar.tsx`
- Create: `products/liteasy/apps/desktop/src/app/layout/LeftPane.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/TopBar.test.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/AppDialogs.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/AppDialogs.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/network/cloudErrorMessage.ts`
- Create: `products/liteasy/apps/desktop/src/tests/cloudErrorMessage.test.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useAccountSession.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/account/useAccountSession.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/models/usePolicySync.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/metadata/useDocumentMetadataSync.ts`
...
- Modify: `products/liteasy/apps/desktop/src/tests/useOrganizationData.test.ts`
- Modify: `docs/qa/environment-startup-guide.md`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/useAccountSession.test.ts`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/useProfileActions.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/useProfileActions.test.ts`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/skills/actionRegistry.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/actionRegistry.test.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `products/liteasy/apps/desktop/src/tests/useOrganizationWorkspace.test.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/commandRouter.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/commandRouter.test.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationGovernance.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationGovernancePanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/useOrganizationData.test.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/metadata/useDocumentMetadataSync.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/metadata/DocumentMetadataSyncPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/SettingsPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/LeftPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/SettingsPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Modify: `products/liteasy/apps/desktop/src/tests/assistant.store.test.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/AssistantPane.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/profile/profile.types.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/useProfileActions.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/AcademicArchiveDialog.tsx`
...
- Modify: `products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppDialogs.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/ModeSwitch.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AssistantPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/library/LibraryPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/library/library.css`
- Modify: `products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/assistantSessionHistory.ts`
- Create: `products/liteasy/apps/desktop/src/tests/assistantSessionHistory.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/workspace/workspaceFolderTree.ts`
- Create: `products/liteasy/apps/desktop/src/tests/workspaceFolderTree.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/library/LibraryPane.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/profile/useAcademicProfileDraft.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/profile/AcademicProfileForm.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/useAcademicProfileDraft.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/assistantPresentation.ts`
- Create: `products/liteasy/apps/desktop/src/tests/assistantPresentation.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/ReaderPane.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/ReaderPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/AssistantSidebar.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/AssistantSidebar.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/layout/useAppShellStores.ts`
- Create: `products/liteasy/apps/desktop/src/tests/useAppShellStores.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantHistoryPanel.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/AssistantHistoryPanel.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantMessageList.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/AssistantMessageList.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantComposer.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/AssistantComposer.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/library/libraryDragPayload.ts`
- Create: `products/liteasy/apps/desktop/src/tests/libraryDragPayload.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/library/LibraryPane.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
Verified `cd products/liteasy/apps/desktop && npm test` passes with 62 test files and 210 tests.

- [x] **Step 3: Run desktop production build**

Verified `cd products/liteasy/apps/desktop && npm run build` passes through `tsc` and Vite production build.

- [x] **Step 4: Run dev-cloud tests**

Verified `node --test development/dev-cloud/server.test.mjs development/dev-cloud/providers/openaiResponses.test.mjs` passes with 17 tests.
...
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppDialogs.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationEntryDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationCreateDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationJoinDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationInviteConfirmDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationLeaveConfirmDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/AcademicArchiveDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/features/profile/ClearProfileConfirmDialog.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Modify: `products/liteasy/apps/desktop/src/tests/AppDialogs.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
Verified `node --test development/dev-cloud/server.test.mjs development/dev-cloud/providers/openaiResponses.test.mjs` passes with 17 tests, and focused desktop recommendation/AppShell tests pass. Current live service on port 8787 must be restarted to pick up the fixed server code.
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationActions.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/LeftPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Modify: `products/liteasy/apps/desktop/src/tests/useOrganizationActions.test.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify: `docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
Verified `cd products/liteasy/apps/desktop && npm test -- src/tests/useOrganizationActions.test.ts src/tests/LeftPane.test.tsx src/tests/AppShell.test.tsx src/tests/AppDialogs.test.tsx` passes with 71 tests, `cd products/liteasy/apps/desktop && npm run build` passes, full `cd products/liteasy/apps/desktop && npm test` passes with 62 test files and 213 tests, and `node --test development/dev-cloud/server.test.mjs development/dev-cloud/providers/openaiResponses.test.mjs` passes with 17 tests.
...
Added an AssistantPane regression proving a natural command alias is executed through the same command feedback path, then verified `cd products/liteasy/apps/desktop && npm test -- src/tests/commandRouter.test.ts src/tests/AssistantPane.test.tsx src/tests/AppShell.test.tsx` passes with 80 tests and `cd products/liteasy/apps/desktop && npm run build` passes.
...
Verified `cd products/liteasy/apps/desktop && npm test -- src/tests/useOrganizationActions.test.ts src/tests/LeftPane.test.tsx src/tests/AppShell.test.tsx` passes with 67 tests and `cd products/liteasy/apps/desktop && npm run build` passes.
...
**Files:**
- Add: `products/liteasy/apps/desktop/src/app/features/models/DevCloudEndpointPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/SettingsPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/LeftPane.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Modify: `products/liteasy/apps/desktop/src/tests/SettingsPane.test.tsx`
...
Updated the Phase 3 test guide to explain the 8787/1420 distinction inside settings, then verified `cd products/liteasy/apps/desktop && npm test -- src/tests/SettingsPane.test.tsx src/tests/LeftPane.test.tsx src/tests/useModelSettingsActions.test.ts src/tests/AppShell.test.tsx` passes with 69 tests and `cd products/liteasy/apps/desktop && npm run build` passes.
...
Added an AssistantPane regression proving the command runs through the right-pane feedback flow, then verified `cd products/liteasy/apps/desktop && npm test -- src/tests/commandRouter.test.ts src/tests/actionRegistry.test.ts src/tests/AssistantPane.test.tsx src/tests/AppShell.test.tsx` passes with 89 tests and `cd products/liteasy/apps/desktop && npm run build` passes.
...
Verified `cd products/liteasy/apps/desktop && npm test -- src/tests/LeftPane.test.tsx src/tests/useOrganizationWorkspace.test.ts src/tests/AppShell.test.tsx` passes with 71 tests and `cd products/liteasy/apps/desktop && npm run build` passes.

...
**Files:**
- Create: `products/liteasy/apps/desktop/README.md`
- Create: `products/liteasy/apps/desktop/package.json`
- Create: `products/liteasy/apps/desktop/src/main.tsx`
- Create: `products/liteasy/apps/desktop/src/App.tsx`
- Create: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
- Create: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Create: `products/liteasy/apps/desktop/src-tauri/Cargo.toml`
- Create: `products/liteasy/apps/desktop/src-tauri/src/main.rs`
- Create: `docs/qa/environment-startup-guide.md`

- [ ] **Step 1: Scaffold the desktop app skeleton**

Create a Tauri + React workspace under `products/liteasy/apps/desktop/` with a minimal renderable shell.

```tsx
// products/liteasy/apps/desktop/src/main.tsx
...
```tsx
// products/liteasy/apps/desktop/src/App.tsx
...
Create `docs/qa/environment-startup-guide.md` with:
...
Run: `test -f docs/qa/environment-startup-guide.md && echo PASS`
Expected: `PASS`

- [ ] **Step 4: Verify the shell renders**

Run: `cd products/liteasy/apps/desktop && npm install && npm run tauri dev`
Expected: a desktop window opens showing three visible panes

- [ ] **Step 5: Commit the bootstrap**

```bash
git add products/liteasy/apps/desktop docs/qa/environment-startup-guide.md
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/workspace/workspace.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/workspace/workspace.store.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/library/LibraryPane.tsx`
- Create: `products/liteasy/apps/desktop/src/app/features/library/library.css`
- Create: `products/liteasy/apps/desktop/src/tests/workspace.store.test.ts`

- [ ] **Step 1: Write the failing workspace state test**

```ts
// products/liteasy/apps/desktop/src/tests/workspace.store.test.ts
...
Run: `cd products/liteasy/apps/desktop && npm test -- workspace.store.test.ts`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/workspace products/liteasy/apps/desktop/src/app/features/library products/liteasy/apps/desktop/src/tests/workspace.store.test.ts
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/import/import.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/import/import.store.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/import/ImportButton.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/import.store.test.ts`
- Create: `products/liteasy/apps/desktop/src-tauri/src/import.rs`
...
Run: `cd products/liteasy/apps/desktop && npm test -- import.store.test.ts`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/import products/liteasy/apps/desktop/src/tests/import.store.test.ts products/liteasy/apps/desktop/src-tauri/src
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/assistant.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/assistant.store.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/ModeSwitch.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/assistant.store.test.ts`
...
Run: `cd products/liteasy/apps/desktop && npm test -- assistant.store.test.ts`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/assistant products/liteasy/apps/desktop/src/tests/assistant.store.test.ts
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/retrieval/retrieval.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/retrieval/mockRetriever.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/answerFormatter.ts`
- Create: `products/liteasy/apps/desktop/src/tests/answerFormatter.test.ts`
...
Run: `cd products/liteasy/apps/desktop && npm test -- answerFormatter.test.ts`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/retrieval products/liteasy/apps/desktop/src/app/features/assistant/answerFormatter.ts products/liteasy/apps/desktop/src/tests/answerFormatter.test.ts
...
**Files:**
- Create or modify: `products/liteasy/apps/desktop/src/app/features/settings/settings.types.ts`
- Create or modify: `products/liteasy/apps/desktop/src/app/features/settings/settings.store.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/skills/skillRegistry.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/skills/actionRegistry.ts`
- Modify or replace: `products/liteasy/apps/desktop/src/app/features/assistant/commandRouter.ts`
- Modify or replace: `products/liteasy/apps/desktop/src/tests/commandRouter.test.ts`
...
Run: `cd products/liteasy/apps/desktop && npm test -- commandRouter.test.ts`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/settings products/liteasy/apps/desktop/src/app/features/assistant/commandRouter.ts products/liteasy/apps/desktop/src/tests/commandRouter.test.ts
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/artifacts/artifact.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/artifacts/artifact.store.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/artifacts/ArtifactTabs.tsx`
- Create: `products/liteasy/apps/desktop/src/tests/artifact.store.test.ts`
...
Run: `cd products/liteasy/apps/desktop && npm test -- artifact.store.test.ts`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/artifacts products/liteasy/apps/desktop/src/tests/artifact.store.test.ts
...
**Files:**
- Create: `docs/qa/phase1-test-guide.md`
...
Run: `sed -n '1,220p' docs/qa/phase1-test-guide.md`
Expected: a plain-language test guide with step-by-step instructions

- [ ] **Step 4: Commit the QA guides**

```bash
git add docs/qa/environment-startup-guide.md docs/qa/phase1-test-guide.md
...
Run: `cd products/liteasy/apps/desktop && npm test -- workspace.store.test.ts import.store.test.ts assistant.store.test.ts answerFormatter.test.ts commandRouter.test.ts artifact.store.test.ts`
Expected: all listed tests PASS

- [ ] **Step 2: Run the desktop app for a manual walkthrough**

Run: `cd products/liteasy/apps/desktop && npm run tauri dev`
Expected: the tester can complete the manual checklist from `docs/qa/phase1-test-guide.md`

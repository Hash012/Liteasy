...
**Tech Stack:** React, TypeScript, Vitest, Node.js, existing `development/dev-cloud` route split, JSON file persistence under `development/dev-cloud/.liteasy-data`
...
- `products/liteasy/apps/desktop/src/app/features/collection/useCollectionItems.ts`
  - cloud-only collection loading/saving state
- `products/liteasy/apps/desktop/src/app/features/collection/collectionClient.ts`
  - collection HTTP client only
- `products/liteasy/apps/desktop/src/app/features/collection/collectionRuntime.ts`
  - collection runtime wrapper only
- `products/liteasy/apps/desktop/src/app/features/collection/collectionStorage.ts`
  - removed from the main collection path
- `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationClient.ts`
  - recommendation generation client only
- `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationRuntime.ts`
  - recommendation generation runtime only
- `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCache.types.ts`
  - cache key / cache payload types
- `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCacheClient.ts`
  - recommendation-cache HTTP client only
- `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCacheRuntime.ts`
  - recommendation-cache runtime only
- `products/liteasy/apps/desktop/src/app/features/recommendations/useRecommendations.ts`
  - orchestrates cache get -> generate -> cache put -> clear
- `products/liteasy/apps/desktop/src/tests/useCollectionItems.test.ts`
  - collection cloud-only behavior
- `products/liteasy/apps/desktop/src/tests/recommendationClient.test.ts`
  - recommendation generation client
- `products/liteasy/apps/desktop/src/tests/recommendationCacheClient.test.ts`
  - recommendation-cache client
- `products/liteasy/apps/desktop/src/tests/useRecommendations.test.ts`
...
- `development/dev-cloud/db/jsonFileStore.mjs`
  - generic JSON file persistence
- `development/dev-cloud/db/collectionRepository.mjs`
  - durable collection repository
- `development/dev-cloud/db/recommendationCacheRepository.mjs`
...
- `development/dev-cloud/payloads/recommendationCachePayloads.mjs`
...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/tests/useCollectionItems.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/collection/useCollectionItems.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/collection/collectionStorage.ts`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/useCollectionItems.test.ts
```
...
```bash
git add products/liteasy/apps/desktop/src/app/features/collection/useCollectionItems.ts products/liteasy/apps/desktop/src/app/features/collection/collectionStorage.ts products/liteasy/apps/desktop/src/tests/useCollectionItems.test.ts
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCache.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCacheClient.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCacheRuntime.ts`
- Create: `products/liteasy/apps/desktop/src/tests/recommendationCacheClient.test.ts`
- Modify: `products/liteasy/apps/desktop/src/app/features/recommendations/recommendationRuntime.ts`
- Modify: `products/liteasy/apps/desktop/src/tests/recommendationClient.test.ts`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/recommendationCacheClient.test.ts
```
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/recommendationCacheClient.test.ts src/tests/recommendationClient.test.ts
```
...
```bash
git add products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCache.types.ts products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCacheClient.ts products/liteasy/apps/desktop/src/app/features/recommendations/recommendationCacheRuntime.ts products/liteasy/apps/desktop/src/app/features/recommendations/recommendationRuntime.ts products/liteasy/apps/desktop/src/tests/recommendationCacheClient.test.ts products/liteasy/apps/desktop/src/tests/recommendationClient.test.ts
...
- Modify: `products/liteasy/apps/desktop/src/tests/useRecommendations.test.ts`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/recommendations/useRecommendations.ts products/liteasy/apps/desktop/src/tests/useRecommendations.test.ts
...
**Files:**
- Create: `development/dev-cloud/db/jsonFileStore.mjs`
- Create: `development/dev-cloud/db/collectionRepository.mjs`
- Create: `development/dev-cloud/db/recommendationCacheRepository.mjs`
- Modify: `development/dev-cloud/payloads/collectionPayloads.mjs`
- Create: `development/dev-cloud/payloads/recommendationCachePayloads.mjs`
- Modify: `development/dev-cloud/payloads/recommendationPayloads.mjs`
...
- `jsonFileStore.mjs`
  - data dir defaults to `development/dev-cloud/.liteasy-data`
...
```bash
git add development/dev-cloud/db development/dev-cloud/payloads development/dev-cloud/requestHandler.mjs development/dev-cloud/server.test.mjs
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "drags a recommendation into local collection and restores it on next render|reuses cached recommendations until a collected paper is added to the library"
```
...
```bash
git add products/liteasy/apps/desktop/src/app/layout/AppShell.tsx products/liteasy/apps/desktop/src/tests/AppShell.test.tsx products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx

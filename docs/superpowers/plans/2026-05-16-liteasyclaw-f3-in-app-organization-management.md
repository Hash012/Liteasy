...
**Tech Stack:** React, TypeScript, Vitest, Node.js, existing `development/dev-cloud` request-handler split, JSON-file-backed demo persistence
...
- `products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts`
  - formal organization role and ownership types
- `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationActions.ts`
  - in-app organization action gating and dialog/action orchestration
- `products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
  - role-aware action visibility and button states
- `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationWorkspace.ts`
  - workspace switching only, informed by formalized shared-library ownership/status
- `products/liteasy/apps/desktop/src/app/features/organization/organizationListClient.ts`
  - list client with formal role payload validation
- `products/liteasy/apps/desktop/src/app/features/organization/organizationSummaryClient.ts`
  - summary client with formal role and ownership payload validation
- `products/liteasy/apps/desktop/src/app/features/organization/organizationGovernanceClient.ts`
  - governance client remains read-model oriented
- `products/liteasy/apps/desktop/src/tests/useOrganizationActions.test.ts`
...
- `products/liteasy/apps/desktop/src/tests/useOrganizationWorkspace.test.ts`
...
- `development/dev-cloud/db/organizationRepository.mjs`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/LeftPane.test.tsx src/tests/useOrganizationWorkspace.test.ts
```
...
```bash
git add products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx products/liteasy/apps/desktop/src/tests/useOrganizationWorkspace.test.ts
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/useOrganizationActions.test.ts
```
...
```bash
git add products/liteasy/apps/desktop/src/app/features/organization/useOrganizationActions.ts products/liteasy/apps/desktop/src/tests/useOrganizationActions.test.ts products/liteasy/apps/desktop/src/tests/AppShell.test.tsx
...
**Files:**
- Create: `development/dev-cloud/db/organizationRepository.mjs`
- Modify: `development/dev-cloud/payloads/organizationPayloads.mjs`
...
Use the existing JSON persistence pattern already established in `development/dev-cloud/db/`.
...
```bash
git add development/dev-cloud/db/organizationRepository.mjs development/dev-cloud/payloads/organizationPayloads.mjs development/dev-cloud/server.test.mjs
...
```bash
git add development/dev-cloud/requestHandler.mjs development/dev-cloud/server.test.mjs
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/LeftPane.test.tsx src/tests/AppShell.test.tsx -t "organization"
```
...
```bash
git add products/liteasy/apps/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx products/liteasy/apps/desktop/src/tests/AppShell.test.tsx
...
```bash
git add products/liteasy/apps/desktop/src/app/features/organization/useOrganizationWorkspace.ts products/liteasy/apps/desktop/src/tests/useOrganizationWorkspace.test.ts products/liteasy/apps/desktop/src/tests/AppShell.test.tsx
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/useOrganizationActions.test.ts src/tests/useOrganizationWorkspace.test.ts src/tests/LeftPane.test.tsx
```

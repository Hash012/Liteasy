...
**Architecture:** This plan is an execution coordinator, not a replacement for the detailed SaaS plan docs. It sequences the already-written D2 and M1 work against the current repository state: `development/dev-cloud/server.mjs` still carries mixed responsibilities at 900+ lines, `desktop` still boots from seeded demo papers instead of a file-backed local library root, and the resource-scope modules described by M1 do not yet exist in code.

**Tech Stack:** Node.js, React, TypeScript, Tauri 2, Rust, Vitest, Node test runner, current `docs/saas/` and `docs/qa/` documentation
...
- `development/dev-cloud/server.mjs`: `953` lines
- `products/liteasy/apps/desktop/src/app/layout/useAppShellStores.ts`: still seeds `starterPapers` into the workspace store on startup
- `products/liteasy/apps/desktop/src-tauri/src/main.rs`: only registers `import::mock_import`
- `products/liteasy/apps/desktop/src/app/features/resources/`: does not exist yet
- verification baseline:
  - `node --test development/dev-cloud/server.test.mjs development/dev-cloud/providers/openaiResponses.test.mjs`: PASS
  - `cd products/liteasy/apps/desktop && npm test`: PASS
  - `cd products/liteasy/apps/desktop && npm run build`: PASS
...
- Read: `development/dev-cloud/server.mjs`
- Read: `products/liteasy/apps/desktop/src/app/layout/useAppShellStores.ts`
- Read: `products/liteasy/apps/desktop/src-tauri/src/main.rs`
...
```bash
wc -l development/dev-cloud/server.mjs
```
...
rg -n "starterPapers|mock_import|generate_handler|createWorkspaceStore|features/resources" \
  products/liteasy/apps/desktop/src/app/layout/useAppShellStores.ts \
  products/liteasy/apps/desktop/src-tauri/src/main.rs \
  products/liteasy/apps/desktop/src/app/features \
  products/liteasy/apps/desktop/src/app/features/workspace/workspace.store.ts
```
...
- development/dev-cloud/server.test.mjs
- development/dev-cloud/requestHandler.mjs
- development/dev-cloud/payloads/*.mjs
- development/dev-cloud/README.md
- docs/qa/roadshow-demo-guide.md
- docs/qa/environment-startup-guide.md

F1 write scope:
- products/liteasy/apps/desktop/src/app/features/resources/*
- products/liteasy/apps/desktop/src/app/features/library/*
- products/liteasy/apps/desktop/src/app/features/workspace/*
- products/liteasy/apps/desktop/src/app/layout/AppShell.tsx
- products/liteasy/apps/desktop/src/app/layout/useAppShellStores.ts
- products/liteasy/apps/desktop/src/tests/*
- products/liteasy/apps/desktop/src-tauri/src/local_library.rs
- products/liteasy/apps/desktop/src-tauri/src/main.rs
- docs/qa/environment-startup-guide.md
```
...
- Create: `development/dev-cloud/requestHandler.mjs`
- Create: `development/dev-cloud/payloads/*.mjs`
- Modify: `development/dev-cloud/server.test.mjs`
- Modify if needed: `development/dev-cloud/README.md`
- Modify if behavior changes: `docs/qa/roadshow-demo-guide.md`
...
```text
development/dev-cloud/payloads/policyPayloads.mjs
development/dev-cloud/payloads/recommendationPayloads.mjs
development/dev-cloud/payloads/collectionPayloads.mjs
development/dev-cloud/payloads/organizationPayloads.mjs
development/dev-cloud/payloads/modelPayloads.mjs
```
...
Keep `development/dev-cloud/server.mjs` responsible only for:
...
```bash
git add development/dev-cloud/server.mjs development/dev-cloud/requestHandler.mjs development/dev-cloud/payloads development/dev-cloud/server.test.mjs development/dev-cloud/providers/openaiResponses.test.mjs
...
**Files:**
- Modify if needed: `products/liteasy/apps/desktop/src/app/features/network/cloudErrorMessage.ts`
- Modify if needed: `products/liteasy/apps/desktop/src/app/features/organization/useOrganizationWorkspace.ts`
- Modify if needed: `products/liteasy/apps/desktop/src/tests/cloudErrorMessage.test.ts`
- Modify if needed: `products/liteasy/apps/desktop/src/tests/useOrganizationWorkspace.test.ts`
- Modify only if unavoidable: `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`
- Modify if behavior changes: `docs/qa/roadshow-demo-guide.md`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/cloudErrorMessage.test.ts src/tests/useOrganizationWorkspace.test.ts src/tests/AppShell.test.tsx
```
...
**Files:**
- Read: `docs/qa/roadshow-demo-guide.md`
- Read: `docs/qa/final-demo-handoff.md`
- Test: `development/dev-cloud/server.test.mjs`
- Test: `products/liteasy/apps/desktop/src/tests/*`
...
```bash
rg -n "roadshow|shared library|organization|assistant|artifact|/admin/" docs/qa/roadshow-demo-guide.md docs/qa/final-demo-handoff.md README.md
```
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/resources/resourceScope.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/resources/resourceActionPolicy.ts`
- Create: `products/liteasy/apps/desktop/src/tests/resourceActionPolicy.test.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/library/localLibrary.types.ts`
- Create: `products/liteasy/apps/desktop/src/app/features/library/localLibraryClient.ts`
- Create: `products/liteasy/apps/desktop/src/tests/localLibraryClient.test.ts`
- Create: `products/liteasy/apps/desktop/src-tauri/src/local_library.rs`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/resourceActionPolicy.test.ts src/tests/localLibraryClient.test.ts
```
...
```bash
git add products/liteasy/apps/desktop/src/app/features/resources products/liteasy/apps/desktop/src/app/features/library/localLibrary.types.ts products/liteasy/apps/desktop/src/app/features/library/localLibraryClient.ts products/liteasy/apps/desktop/src/tests/resourceActionPolicy.test.ts products/liteasy/apps/desktop/src/tests/localLibraryClient.test.ts products/liteasy/apps/desktop/src-tauri/src/local_library.rs products/liteasy/apps/desktop/src-tauri/src/main.rs
...
- Modify: `products/liteasy/apps/desktop/src/app/layout/useAppShellStores.ts`
...
- Modify: `products/liteasy/apps/desktop/src/app/features/workspace/workspace.store.ts`
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/resourceActionPolicy.test.ts
cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "loads the LiteasyClaw local library root on startup"
cd products/liteasy/apps/desktop && npm test -- src/tests/LeftPane.test.tsx -t "shows the local library root and refresh affordance"
```
...
- `node --test development/dev-cloud/server.test.mjs development/dev-cloud/providers/openaiResponses.test.mjs` passes
- `cd products/liteasy/apps/desktop && npm test` passes
- `cd products/liteasy/apps/desktop && npm run build` passes

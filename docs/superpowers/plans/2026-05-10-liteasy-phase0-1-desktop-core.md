...
- Create: `desktop/src/app/layout/AppShell.tsx`
- Create: `desktop/src/app/styles/app.css`
...
Create a Tauri + React workspace under `desktop/` with a minimal renderable shell.
...
```tsx
// desktop/src/app/layout/AppShell.tsx
...
**Files:**
- Create: `desktop/src/app/features/workspace/workspace.types.ts`
- Create: `desktop/src/app/features/workspace/workspace.store.ts`
- Create: `desktop/src/app/features/library/LibraryPane.tsx`
- Create: `desktop/src/app/features/library/library.css`
- Create: `desktop/src/tests/workspace.store.test.ts`

- [ ] **Step 1: Write the failing workspace state test**

```ts
// desktop/src/tests/workspace.store.test.ts
...
Run: `cd desktop && npm test -- workspace.store.test.ts`
Expected: FAIL because the store does not exist yet

- [ ] **Step 3: Implement the minimal workspace store**

```ts
// desktop/src/app/features/workspace/workspace.store.ts
...
```bash
git add desktop/src/app/features/workspace desktop/src/app/features/library desktop/src/tests/workspace.store.test.ts
...
- Create: `desktop/src/app/features/import/import.store.ts`
- Create: `desktop/src/app/features/import/ImportButton.tsx`
- Create: `desktop/src/tests/import.store.test.ts`
- Create: `desktop/src-tauri/src/import.rs`
...
Run: `cd desktop && npm test -- import.store.test.ts`
...
```bash
git add desktop/src/app/features/import desktop/src/tests/import.store.test.ts desktop/src-tauri/src
...
**Files:**
- Create: `desktop/src/app/features/assistant/assistant.types.ts`
- Create: `desktop/src/app/features/assistant/assistant.store.ts`
- Create: `desktop/src/app/features/assistant/AssistantPane.tsx`
- Create: `desktop/src/app/features/assistant/ModeSwitch.tsx`
- Create: `desktop/src/tests/assistant.store.test.ts`
...
Run: `cd desktop && npm test -- assistant.store.test.ts`
...
```bash
git add desktop/src/app/features/assistant desktop/src/tests/assistant.store.test.ts
...
**Files:**
- Create: `desktop/src/app/features/retrieval/retrieval.types.ts`
- Create: `desktop/src/app/features/retrieval/mockRetriever.ts`
- Create: `desktop/src/app/features/assistant/answerFormatter.ts`
- Create: `desktop/src/tests/answerFormatter.test.ts`
...
Run: `cd desktop && npm test -- answerFormatter.test.ts`
...
```bash
git add desktop/src/app/features/retrieval desktop/src/app/features/assistant/answerFormatter.ts desktop/src/tests/answerFormatter.test.ts
...
**Files:**
- Create: `desktop/src/app/features/artifacts/artifact.types.ts`
- Create: `desktop/src/app/features/artifacts/artifact.store.ts`
- Create: `desktop/src/app/features/artifacts/ArtifactTabs.tsx`
- Create: `desktop/src/tests/artifact.store.test.ts`
...
```bash
git add desktop/src/app/features/artifacts desktop/src/tests/artifact.store.test.ts
...
Run: `cd desktop && npm test -- workspace.store.test.ts import.store.test.ts assistant.store.test.ts answerFormatter.test.ts commandRouter.test.ts artifact.store.test.ts`

...
- `products/liteasy/apps/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`: add `RuntimeContextIssue` and `AgentRuntimeContextView`.
- `products/liteasy/apps/desktop/src/app/features/agent-runtime/contextView.ts`: build context summaries and readiness issues from AssistantPane-friendly inputs.
- `products/liteasy/apps/desktop/src/tests/agentRuntimeContextView.test.ts`: verify ready, empty, unlocked, partially imported, and unknown workspace contexts.
- `products/liteasy/apps/desktop/src/app/features/assistant/AssistantContextPanel.tsx`: render collapsed summary and expanded grouped context details.
- `products/liteasy/apps/desktop/src/tests/AssistantContextPanel.test.tsx`: verify collapsed and expanded panel behavior.
- `products/liteasy/apps/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts`: use `contextView` to guard artifact commands before handler execution.
- `products/liteasy/apps/desktop/src/tests/agentRuntimeOrchestrator.test.ts`: extend mind map context readiness coverage.
- `products/liteasy/apps/desktop/src/app/features/assistant/AssistantPane.tsx`: build context view, render the panel, and pass context to runtime.
- `products/liteasy/apps/desktop/src/tests/AssistantPane.test.tsx`: verify context panel rendering and context-aware mind map command behavior.
- `products/liteasy/apps/desktop/src/app/styles/app.css`: add compact context panel styles.
...
- Create: `products/liteasy/apps/desktop/src/app/features/agent-runtime/contextView.ts`
- Test: `products/liteasy/apps/desktop/src/tests/agentRuntimeContextView.test.ts`

- [ ] **Step 1: Write the failing context-view test**

Create `products/liteasy/apps/desktop/src/tests/agentRuntimeContextView.test.ts`:
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/agentRuntimeContextView.test.ts
```
...
Modify `products/liteasy/apps/desktop/src/app/features/agent-runtime/agentRuntime.types.ts` by adding these types after `AgentRuntimeExecutionContext`:
...
```bash
git add products/liteasy/apps/desktop/src/app/features/agent-runtime/agentRuntime.types.ts products/liteasy/apps/desktop/src/app/features/agent-runtime/contextView.ts products/liteasy/apps/desktop/src/tests/agentRuntimeContextView.test.ts
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/assistant/AssistantContextPanel.tsx`
- Modify: `products/liteasy/apps/desktop/src/app/styles/app.css`
- Test: `products/liteasy/apps/desktop/src/tests/AssistantContextPanel.test.tsx`

- [ ] **Step 1: Write the failing component test**

Create `products/liteasy/apps/desktop/src/tests/AssistantContextPanel.test.tsx`:
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/AssistantContextPanel.test.tsx
```
...
Append these styles near the existing assistant styles in `products/liteasy/apps/desktop/src/app/styles/app.css`:
...
```bash
git add products/liteasy/apps/desktop/src/app/features/assistant/AssistantContextPanel.tsx products/liteasy/apps/desktop/src/app/styles/app.css products/liteasy/apps/desktop/src/tests/AssistantContextPanel.test.tsx
...
Append these tests to `products/liteasy/apps/desktop/src/tests/agentRuntimeOrchestrator.test.ts`:
...
Modify `AgentRuntimeExecutionContext` in `products/liteasy/apps/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`:
...
```bash
git add products/liteasy/apps/desktop/src/app/features/agent-runtime/agentRuntime.types.ts products/liteasy/apps/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts products/liteasy/apps/desktop/src/tests/agentRuntimeOrchestrator.test.ts
...
Append these tests to `products/liteasy/apps/desktop/src/tests/AssistantPane.test.tsx`:
...
```bash
cd products/liteasy/apps/desktop && npm test -- src/tests/agentRuntimeContextView.test.ts src/tests/AssistantContextPanel.test.tsx src/tests/agentRuntimeOrchestrator.test.ts src/tests/AssistantPane.test.tsx
```

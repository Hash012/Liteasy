...
**Tech Stack:** Existing product stack plus advanced media generation services, plugin runtime permissions, SDK scaffolding, extended audit hooks
...
- Primary outcomes:
  ...
  - built-in focus and task-list plugin flows
  - optional external-data consent integration seam
- Required exit artifacts:
  - updated environment guide
  - Phase 4 test guide
  - extension safety limitations log

...
**Files:**
- Modify: `products/liteasy/apps/desktop/src/tests/modelSemanticPlanner.test.ts`
...
- Modify only if needed: `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`
...
**Files:**
- Create: `docs/superpowers/specs/2026-07-05-liteasyclaw-intent-native-generative-ui-architecture-rendered.backup-2026-07-06-before-sequential-actions.html`
- Modify: `docs/superpowers/specs/2026-07-05-liteasyclaw-intent-native-generative-ui-architecture-rendered.html`

- [ ] **Step 1: Backup the current rendered architecture HTML**

Run: `cp docs/superpowers/specs/2026-07-05-liteasyclaw-intent-native-generative-ui-architecture-rendered.html docs/superpowers/specs/2026-07-05-liteasyclaw-intent-native-generative-ui-architecture-rendered.backup-2026-07-06-before-sequential-actions.html`
...
Run: `rg -n "ordered actions|顺序|Sequential|PlanExecutor|IntentPlan" docs/superpowers/specs/2026-07-05-liteasyclaw-intent-native-generative-ui-architecture-rendered.html`

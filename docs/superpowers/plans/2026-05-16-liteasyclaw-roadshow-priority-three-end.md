...
**Tech Stack:** Node.js, existing `development/dev-cloud` route split, JSON-file demo persistence, React desktop frontend, QA markdown docs
...
- `development/dev-cloud/db/sessionRepository.mjs`
  - active session tracking
- `development/dev-cloud/db/adminActivityRepository.mjs`
...
- `development/dev-cloud/payloads/adminDemoStatePayloads.mjs`
  - aggregate operations-console state payload
- `development/dev-cloud/payloads/adminDemoActionPayloads.mjs`
  - demo reset / reseed / cache clear payloads
- `development/dev-cloud/adminConsole.mjs`
...
**Files:**
- Create: `development/dev-cloud/db/sessionRepository.mjs`
- Create: `development/dev-cloud/db/adminActivityRepository.mjs`
- Modify: `development/dev-cloud/db/collectionRepository.mjs`
- Modify: `development/dev-cloud/db/recommendationCacheRepository.mjs`
- Modify: `development/dev-cloud/db/organizationRepository.mjs`
- Create: `development/scripts/reset-demo-data.mjs`
- Create: `development/scripts/reseed-demo-data.mjs`
...
```bash
git add development/dev-cloud/db development/dev-cloud/server.test.mjs development/scripts/reset-demo-data.mjs development/scripts/reseed-demo-data.mjs
...
**Files:**
- Create: `development/dev-cloud/payloads/adminDemoStatePayloads.mjs`
- Create: `development/dev-cloud/payloads/adminDemoActionPayloads.mjs`
...
```bash
git add development/dev-cloud/payloads development/dev-cloud/requestHandler.mjs development/dev-cloud/server.test.mjs
...
**Files:**
- Modify: `development/dev-cloud/adminConsole.mjs`
- Modify: `development/dev-cloud/server.test.mjs`
...
```bash
git add development/dev-cloud/adminConsole.mjs development/dev-cloud/server.test.mjs
...
**Files:**
- Create: `development/scripts/smoke-roadshow.mjs`
- Modify: `development/dev-cloud/README.md`
...
```bash
git add development/scripts/smoke-roadshow.mjs development/dev-cloud/README.md

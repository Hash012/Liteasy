...
- organization entry UI in `products/liteasy/apps/desktop/src/app/features/organization/`
...
`products/liteasy/apps/desktop/src/app/features/organization/organization.types.ts` must become the single shared contract for:
...
`development/dev-cloud/` should formalize organization actions without collapsing them into unrelated modules.

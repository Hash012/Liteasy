...
- `services/dev-cloud/providers/openaiResponses.mjs`
  - a minimal OpenAI Responses API provider
- `desktop/src/app/features/models/modelGateway.ts`
  - policy-aware model access gating
- `desktop/src/app/features/assistant/generateAssistantAnswer.ts`
  - current prompt assembly and answer generation path
- `desktop/src/app/features/skills/skillRegistry.ts`
  - local skill-to-action routing seam
- `desktop/src/app/features/skills/actionRegistry.ts`
...
This extends the current prototype in `desktop/src/app/features/skills/actionRegistry.ts` into a proper boundary.

...
参考：`docs/research/brainstorm/intent-native-generative-ui-module-design.html`、`docs/research/brainstorm/intent-native-generative-ui-module-design.md`、`docs/product/LiteasyClaw_功能与UI设计文档1.0.md`
...
```text
products/liteasy/apps/desktop/src/app/features/generative-ui/
...
这符合 `docs/research/brainstorm/intent-native-generative-ui-module-design.md` 的主张：模型不是主权层，schema、registry、policy、state kernel、journal 和 runtime validator 才是主权层。

### 9.3 UX 严谨性

参考 `docs/research/brainstorm/reference/reading-notes.md` 中 UXBench 的三类维度：

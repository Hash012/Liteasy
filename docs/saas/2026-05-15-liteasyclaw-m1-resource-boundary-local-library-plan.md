...
- `products/liteasy/apps/desktop/src/app/features/resources/resourceScope.types.ts`: defines the five resource classes and shared ownership metadata.
- `products/liteasy/apps/desktop/src/app/features/resources/resourceActionPolicy.ts`: maps actions to resource classes and risk rules.
- `products/liteasy/apps/desktop/src/app/features/library/localLibrary.types.ts`: typed local-library entries returned from the runtime seam.
- `products/liteasy/apps/desktop/src/app/features/library/localLibraryClient.ts`: thin UI-facing client for the Tauri local-library command.
- `products/liteasy/apps/desktop/src/app/features/library/useLocalLibrary.ts`: loads, refreshes, and normalizes the local library snapshot.
- `products/liteasy/apps/desktop/src/app/features/workspace/workspace.types.ts`: extends workspace state with source metadata and resource ownership fields.
- `products/liteasy/apps/desktop/src/app/features/workspace/workspace.store.ts`: stores the loaded workspace source and file-backed papers.
- `products/liteasy/apps/desktop/src/app/layout/AppShell.tsx`: wires local library loading into the app bootstrap path.
- `products/liteasy/apps/desktop/src/app/features/library/LibraryPane.tsx`: renders the local library root label and refresh affordance.
- `products/liteasy/apps/desktop/src-tauri/src/local_library.rs`: creates or opens the local library folder and returns a normalized snapshot.
- `products/liteasy/apps/desktop/src-tauri/src/main.rs`: registers the new local-library Tauri command.
- `products/liteasy/apps/desktop/src/tests/resourceActionPolicy.test.ts`: verifies resource-class and risk-policy rules.
- `products/liteasy/apps/desktop/src/tests/localLibraryClient.test.ts`: verifies local-library client payload parsing.
- `products/liteasy/apps/desktop/src/tests/AppShell.test.tsx`: verifies desktop bootstrap loads the local library workspace.
...
- Test: `products/liteasy/apps/desktop/src/tests/resourceActionPolicy.test.ts`
...
Run: `cd products/liteasy/apps/desktop && npm test -- src/tests/resourceActionPolicy.test.ts`
...
```ts
// products/liteasy/apps/desktop/src/app/features/resources/resourceScope.types.ts
...
```ts
// products/liteasy/apps/desktop/src/app/features/resources/resourceActionPolicy.ts
...
```bash
git add products/liteasy/apps/desktop/src/app/features/resources products/liteasy/apps/desktop/src/tests/resourceActionPolicy.test.ts
...
Run: `cd products/liteasy/apps/desktop && npm test -- src/tests/localLibraryClient.test.ts`
Expected: FAIL because the local-library client files do not exist.

- [ ] **Step 3: Add the minimal client and Tauri command seam**

```ts
// products/liteasy/apps/desktop/src/app/features/library/localLibrary.types.ts
...
```ts
// products/liteasy/apps/desktop/src/app/features/library/localLibraryClient.ts
...
**Files:**
- Create: `products/liteasy/apps/desktop/src/app/features/library/useLocalLibrary.ts`
...
Run: `cd products/liteasy/apps/desktop && npm test -- src/tests/AppShell.test.tsx -t "loads the LiteasyClaw local library root on startup"`
...
```ts
// products/liteasy/apps/desktop/src/app/features/library/useLocalLibrary.ts
...
```ts
// products/liteasy/apps/desktop/src/app/features/workspace/workspace.types.ts
...
Run: `cd products/liteasy/apps/desktop && npm test -- src/tests/LeftPane.test.tsx -t "shows the local library root and refresh affordance"`
...
```bash
git add products/liteasy/apps/desktop/src/app/features/library/LibraryPane.tsx products/liteasy/apps/desktop/src/app/features/library/library.css products/liteasy/apps/desktop/src/tests/LeftPane.test.tsx
...
cd products/liteasy/apps/desktop && npm test -- src/tests/localLibraryClient.test.ts

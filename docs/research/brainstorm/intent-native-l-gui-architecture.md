...
- `docs/research/brainstorm/intent-native-l-gui-architecture.mmd`
- `docs/research/brainstorm/intent-native-l-gui-architecture.html`
- 参考材料：`docs/research/brainstorm/L-GUI Architecture_ The Generative UI Paradigm.pdf`

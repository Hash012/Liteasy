...
1. 读第 0-5 节。
2. 看 `docs/research/brainstorm/mature-intent-native-generative-ui-build-guide.html`。
3. 再读第 21-32 节的构建步骤。
...
- `docs/research/brainstorm/mature-intent-native-generative-ui-build-guide.mmd`
- `docs/research/brainstorm/mature-intent-native-generative-ui-build-guide.html`
...
- `docs/research/brainstorm/L-GUI Architecture_ The Generative UI Paradigm.pdf`
...
- SVG：`docs/research/brainstorm/mature-intent-native-generative-ui-build-guide1-mermaid.svg`
- PNG：`docs/research/brainstorm/mature-intent-native-generative-ui-build-guide1-mermaid.png`
- PDF：`docs/research/brainstorm/mature-intent-native-generative-ui-build-guide1-mermaid.pdf`

...
- `docs/engineering/agent-architecture-audit.md`，用于约束 LiteasyClaw 当前仍是一个主 Agent Host，而不是完整多 Agent runtime。
- `docs/agent-dev/2026-07-19-multi-paper-analysis-agent-feasibility-and-stack.md`，用于复用 evidence matrix、coverage gap、claim/evidence 和 artifact source 的既有设计。

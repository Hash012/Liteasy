...
- `LiteasyClaw/desktop/src/app/features/resources/resourceScope.types.ts`: defines the five resource classes and shared ownership metadata.
- `LiteasyClaw/desktop/src/app/features/resources/resourceActionPolicy.ts`: maps actions to resource classes and risk rules.
- `LiteasyClaw/desktop/src/app/features/library/localLibrary.types.ts`: typed local-library entries returned from the runtime seam.
- `LiteasyClaw/desktop/src/app/features/library/localLibraryClient.ts`: thin UI-facing client for the Tauri local-library command.
- `LiteasyClaw/desktop/src/app/features/library/useLocalLibrary.ts`: loads, refreshes, and normalizes the local library snapshot.
- `LiteasyClaw/desktop/src/app/features/workspace/workspace.types.ts`: extends workspace state with source metadata and resource ownership fields.
- `LiteasyClaw/desktop/src/app/features/workspace/workspace.store.ts`: stores the loaded workspace source and file-backed papers.
- `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`: wires local library loading into the app bootstrap path.
- `LiteasyClaw/desktop/src/app/features/library/LibraryPane.tsx`: renders the local library root label and refresh affordance.
- `LiteasyClaw/desktop/src-tauri/src/local_library.rs`: creates or opens the local library folder and returns a normalized snapshot.
- `LiteasyClaw/desktop/src-tauri/src/main.rs`: registers the new local-library Tauri command.
- `LiteasyClaw/desktop/src/tests/resourceActionPolicy.test.ts`: verifies resource-class and risk-policy rules.
- `LiteasyClaw/desktop/src/tests/localLibraryClient.test.ts`: verifies local-library client payload parsing.
- `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`: verifies desktop bootstrap loads the local library workspace.
- `project-docs/qa/environment-startup-guide.md`: explains the local library root and how testers verify it exists.
...
- Test: `LiteasyClaw/desktop/src/tests/resourceActionPolicy.test.ts`
...
Run: `cd LiteasyClaw/desktop && npm test -- src/tests/resourceActionPolicy.test.ts`
...
```ts
// LiteasyClaw/desktop/src/app/features/resources/resourceScope.types.ts
...
```ts
// LiteasyClaw/desktop/src/app/features/resources/resourceActionPolicy.ts
...
```bash
git add LiteasyClaw/desktop/src/app/features/resources LiteasyClaw/desktop/src/tests/resourceActionPolicy.test.ts
...
Run: `cd LiteasyClaw/desktop && npm test -- src/tests/localLibraryClient.test.ts`
Expected: FAIL because the local-library client files do not exist.

- [ ] **Step 3: Add the minimal client and Tauri command seam**

```ts
// LiteasyClaw/desktop/src/app/features/library/localLibrary.types.ts
...
```ts
// LiteasyClaw/desktop/src/app/features/library/localLibraryClient.ts
...
```bash
git add LiteasyClaw/desktop/src/app/features/library/localLibrary.types.ts LiteasyClaw/desktop/src/app/features/library/localLibraryClient.ts LiteasyClaw/desktop/src/tests/localLibraryClient.test.ts LiteasyClaw/desktop/src-tauri/src/local_library.rs LiteasyClaw/desktop/src-tauri/src/main.rs
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/library/useLocalLibrary.ts`
...
Run: `cd LiteasyClaw/desktop && npm test -- src/tests/AppShell.test.tsx -t "loads the LiteasyClaw local library root on startup"`
...
```ts
// LiteasyClaw/desktop/src/app/features/library/useLocalLibrary.ts
...
```ts
// LiteasyClaw/desktop/src/app/features/workspace/workspace.types.ts
...
```bash
git add LiteasyClaw/desktop/src/app/features/library/useLocalLibrary.ts LiteasyClaw/desktop/src/app/features/workspace/workspace.types.ts LiteasyClaw/desktop/src/app/features/workspace/workspace.store.ts LiteasyClaw/desktop/src/app/layout/AppShell.tsx LiteasyClaw/desktop/src/tests/AppShell.test.tsx
...
- Test: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
...
Run: `cd LiteasyClaw/desktop && npm test -- src/tests/LeftPane.test.tsx -t "shows the local library root and refresh affordance"`
...
```bash
git add LiteasyClaw/desktop/src/app/features/library/LibraryPane.tsx LiteasyClaw/desktop/src/app/features/library/library.css LiteasyClaw/desktop/src/tests/LeftPane.test.tsx
...
Run: `rg -n "LiteasyLibrary|本地文献库" project-docs/qa/environment-startup-guide.md`
Expected: at least one match for the new local-library instructions

- [ ] **Step 3: Commit the guide update**

```bash
git add project-docs/qa/environment-startup-guide.md
...
cd LiteasyClaw/desktop && npm test -- src/tests/localLibraryClient.test.ts

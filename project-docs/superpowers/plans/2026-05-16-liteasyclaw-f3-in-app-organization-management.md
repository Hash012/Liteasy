...
**Tech Stack:** React, TypeScript, Vitest, Node.js, existing `LiteasyClaw/services/dev-cloud` request-handler split, JSON-file-backed demo persistence
...
- `LiteasyClaw/desktop/src/app/features/organization/organization.types.ts`
  - formal organization role and ownership types
- `LiteasyClaw/desktop/src/app/features/organization/useOrganizationActions.ts`
  - in-app organization action gating and dialog/action orchestration
- `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
  - role-aware action visibility and button states
- `LiteasyClaw/desktop/src/app/features/organization/useOrganizationWorkspace.ts`
  - workspace switching only, informed by formalized shared-library ownership/status
- `LiteasyClaw/desktop/src/app/features/organization/organizationListClient.ts`
  - list client with formal role payload validation
- `LiteasyClaw/desktop/src/app/features/organization/organizationSummaryClient.ts`
  - summary client with formal role and ownership payload validation
- `LiteasyClaw/desktop/src/app/features/organization/organizationGovernanceClient.ts`
...
- `project-docs/qa/phase3-test-guide.md`
- `project-docs/qa/phase3-governance-limitations.md`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/LeftPane.test.tsx src/tests/useOrganizationWorkspace.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/organization/organization.types.ts LiteasyClaw/desktop/src/tests/LeftPane.test.tsx LiteasyClaw/desktop/src/tests/useOrganizationWorkspace.test.ts
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/useOrganizationActions.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/organization/useOrganizationActions.ts LiteasyClaw/desktop/src/tests/useOrganizationActions.test.ts LiteasyClaw/desktop/src/tests/AppShell.test.tsx
...
**Files:**
- Create: `LiteasyClaw/services/dev-cloud/db/organizationRepository.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/payloads/organizationPayloads.mjs`
...
Use the existing JSON persistence pattern already established in `LiteasyClaw/services/dev-cloud/db/`.
...
```bash
git add LiteasyClaw/services/dev-cloud/db/organizationRepository.mjs LiteasyClaw/services/dev-cloud/payloads/organizationPayloads.mjs LiteasyClaw/services/dev-cloud/server.test.mjs
...
```bash
git add LiteasyClaw/services/dev-cloud/requestHandler.mjs LiteasyClaw/services/dev-cloud/server.test.mjs
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/LeftPane.test.tsx src/tests/AppShell.test.tsx -t "organization"
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx LiteasyClaw/desktop/src/tests/LeftPane.test.tsx LiteasyClaw/desktop/src/tests/AppShell.test.tsx
...
```bash
git add LiteasyClaw/desktop/src/app/features/organization/useOrganizationWorkspace.ts LiteasyClaw/desktop/src/tests/useOrganizationWorkspace.test.ts LiteasyClaw/desktop/src/tests/AppShell.test.tsx
...
```bash
rg -n "owner|admin|member|组织管理|共享文献库|/admin/" project-docs/qa/phase3-test-guide.md project-docs/qa/phase3-governance-limitations.md project-docs/qa/final-demo-handoff.md
```
...
```bash
git add project-docs/qa/phase3-test-guide.md project-docs/qa/phase3-governance-limitations.md project-docs/qa/final-demo-handoff.md
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/useOrganizationActions.test.ts src/tests/useOrganizationWorkspace.test.ts src/tests/LeftPane.test.tsx
```

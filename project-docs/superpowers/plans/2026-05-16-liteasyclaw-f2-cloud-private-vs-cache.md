...
**Tech Stack:** React, TypeScript, Vitest, Node.js, existing `LiteasyClaw/services/dev-cloud` route split, JSON file persistence under `LiteasyClaw/services/dev-cloud/.liteasy-data`
...
- `LiteasyClaw/desktop/src/app/features/collection/useCollectionItems.ts`
  - cloud-only collection loading/saving state
- `LiteasyClaw/desktop/src/app/features/collection/collectionClient.ts`
  - collection HTTP client only
- `LiteasyClaw/desktop/src/app/features/collection/collectionRuntime.ts`
  - collection runtime wrapper only
- `LiteasyClaw/desktop/src/app/features/collection/collectionStorage.ts`
  - removed from the main collection path
- `LiteasyClaw/desktop/src/app/features/recommendations/recommendationClient.ts`
  - recommendation generation client only
- `LiteasyClaw/desktop/src/app/features/recommendations/recommendationRuntime.ts`
  - recommendation generation runtime only
- `LiteasyClaw/desktop/src/app/features/recommendations/recommendationCache.types.ts`
  - cache key / cache payload types
- `LiteasyClaw/desktop/src/app/features/recommendations/recommendationCacheClient.ts`
  - recommendation-cache HTTP client only
- `LiteasyClaw/desktop/src/app/features/recommendations/recommendationCacheRuntime.ts`
  - recommendation-cache runtime only
- `LiteasyClaw/desktop/src/app/features/recommendations/useRecommendations.ts`
  - orchestrates cache get -> generate -> cache put -> clear
- `LiteasyClaw/desktop/src/tests/useCollectionItems.test.ts`
  - collection cloud-only behavior
- `LiteasyClaw/desktop/src/tests/recommendationClient.test.ts`
  - recommendation generation client
- `LiteasyClaw/desktop/src/tests/recommendationCacheClient.test.ts`
  - recommendation-cache client
- `LiteasyClaw/desktop/src/tests/useRecommendations.test.ts`
...
- `LiteasyClaw/services/dev-cloud/db/jsonFileStore.mjs`
  - generic JSON file persistence
- `LiteasyClaw/services/dev-cloud/db/collectionRepository.mjs`
  - durable collection repository
- `LiteasyClaw/services/dev-cloud/db/recommendationCacheRepository.mjs`
...
- `LiteasyClaw/services/dev-cloud/payloads/recommendationCachePayloads.mjs`
...
- `project-docs/qa/phase2-test-guide.md`
- `project-docs/qa/phase2-known-limitations.md`
- `project-docs/qa/final-demo-handoff.md`

## Task 1: Remove Local Collection Recovery from the Main Desktop Path

**Files:**
- Modify: `LiteasyClaw/desktop/src/tests/useCollectionItems.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/collection/useCollectionItems.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/collection/collectionStorage.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/useCollectionItems.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/collection/useCollectionItems.ts LiteasyClaw/desktop/src/app/features/collection/collectionStorage.ts LiteasyClaw/desktop/src/tests/useCollectionItems.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/recommendations/recommendationCache.types.ts`
- Create: `LiteasyClaw/desktop/src/app/features/recommendations/recommendationCacheClient.ts`
- Create: `LiteasyClaw/desktop/src/app/features/recommendations/recommendationCacheRuntime.ts`
- Create: `LiteasyClaw/desktop/src/tests/recommendationCacheClient.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/recommendations/recommendationRuntime.ts`
- Modify: `LiteasyClaw/desktop/src/tests/recommendationClient.test.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/recommendationCacheClient.test.ts
```
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/recommendationCacheClient.test.ts src/tests/recommendationClient.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/recommendations/recommendationCache.types.ts LiteasyClaw/desktop/src/app/features/recommendations/recommendationCacheClient.ts LiteasyClaw/desktop/src/app/features/recommendations/recommendationCacheRuntime.ts LiteasyClaw/desktop/src/app/features/recommendations/recommendationRuntime.ts LiteasyClaw/desktop/src/tests/recommendationCacheClient.test.ts LiteasyClaw/desktop/src/tests/recommendationClient.test.ts
...
- Modify: `LiteasyClaw/desktop/src/tests/useRecommendations.test.ts`
...
```bash
git add LiteasyClaw/desktop/src/app/features/recommendations/useRecommendations.ts LiteasyClaw/desktop/src/tests/useRecommendations.test.ts
...
**Files:**
- Create: `LiteasyClaw/services/dev-cloud/db/jsonFileStore.mjs`
- Create: `LiteasyClaw/services/dev-cloud/db/collectionRepository.mjs`
- Create: `LiteasyClaw/services/dev-cloud/db/recommendationCacheRepository.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/payloads/collectionPayloads.mjs`
- Create: `LiteasyClaw/services/dev-cloud/payloads/recommendationCachePayloads.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/payloads/recommendationPayloads.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/requestHandler.mjs`
...
- `jsonFileStore.mjs`
  - data dir defaults to `LiteasyClaw/services/dev-cloud/.liteasy-data`
...
```bash
git add LiteasyClaw/services/dev-cloud/db LiteasyClaw/services/dev-cloud/payloads LiteasyClaw/services/dev-cloud/requestHandler.mjs LiteasyClaw/services/dev-cloud/server.test.mjs
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/AppShell.test.tsx -t "drags a recommendation into local collection and restores it on next render|reuses cached recommendations until a collected paper is added to the library"
```
...
```bash
git add LiteasyClaw/desktop/src/app/layout/AppShell.tsx LiteasyClaw/desktop/src/tests/AppShell.test.tsx LiteasyClaw/desktop/src/tests/LeftPane.test.tsx
...
**Files:**
- Modify: `project-docs/qa/phase2-test-guide.md`
- Modify: `project-docs/qa/phase2-known-limitations.md`
- Modify: `project-docs/qa/final-demo-handoff.md`
...
```bash
rg -n "云端收藏|推荐缓存|清理缓存|不影响收藏|本地恢复" project-docs/qa/phase2-test-guide.md project-docs/qa/phase2-known-limitations.md project-docs/qa/final-demo-handoff.md
```
...
```bash
git add project-docs/qa/phase2-test-guide.md project-docs/qa/phase2-known-limitations.md project-docs/qa/final-demo-handoff.md

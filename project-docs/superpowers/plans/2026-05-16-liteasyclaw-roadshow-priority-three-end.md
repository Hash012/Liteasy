...
**Tech Stack:** Node.js, existing `LiteasyClaw/services/dev-cloud` route split, JSON-file demo persistence, React desktop frontend, QA markdown docs
...
- `LiteasyClaw/services/dev-cloud/db/sessionRepository.mjs`
  - active session tracking
- `LiteasyClaw/services/dev-cloud/db/adminActivityRepository.mjs`
  - recent internal operations and recent customer-side activity feed
- `LiteasyClaw/scripts/reset-demo-data.mjs`
  - clear or reset current demo data
- `LiteasyClaw/scripts/reseed-demo-data.mjs`
  - write deterministic baseline demo data
- `LiteasyClaw/scripts/smoke-roadshow.mjs`
  - roadshow smoke-check script

### Dev-cloud route/payload layer

- `LiteasyClaw/services/dev-cloud/payloads/adminDemoStatePayloads.mjs`
  - aggregate operations-console state payload
- `LiteasyClaw/services/dev-cloud/payloads/adminDemoActionPayloads.mjs`
  - demo reset / reseed / cache clear payloads
- `LiteasyClaw/services/dev-cloud/adminConsole.mjs`
...
**Files:**
- Create: `LiteasyClaw/services/dev-cloud/db/sessionRepository.mjs`
- Create: `LiteasyClaw/services/dev-cloud/db/adminActivityRepository.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/db/collectionRepository.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/db/recommendationCacheRepository.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/db/organizationRepository.mjs`
- Create: `LiteasyClaw/scripts/reset-demo-data.mjs`
- Create: `LiteasyClaw/scripts/reseed-demo-data.mjs`
...
```bash
git add LiteasyClaw/services/dev-cloud/db LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/scripts/reset-demo-data.mjs LiteasyClaw/scripts/reseed-demo-data.mjs
...
**Files:**
- Create: `LiteasyClaw/services/dev-cloud/payloads/adminDemoStatePayloads.mjs`
- Create: `LiteasyClaw/services/dev-cloud/payloads/adminDemoActionPayloads.mjs`
...
```bash
git add LiteasyClaw/services/dev-cloud/payloads LiteasyClaw/services/dev-cloud/requestHandler.mjs LiteasyClaw/services/dev-cloud/server.test.mjs
...
**Files:**
- Modify: `LiteasyClaw/services/dev-cloud/adminConsole.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/server.test.mjs`
...
```bash
git add LiteasyClaw/services/dev-cloud/adminConsole.mjs LiteasyClaw/services/dev-cloud/server.test.mjs
...
**Files:**
- Create: `LiteasyClaw/scripts/smoke-roadshow.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/README.md`
...
```bash
git add LiteasyClaw/scripts/smoke-roadshow.mjs LiteasyClaw/services/dev-cloud/README.md
...
```bash
rg -n "demo-state|demo-reset|demo-reseed|smoke-roadshow|推荐缓存|运维端" project-docs/qa/roadshow-demo-guide.md project-docs/qa/final-demo-handoff.md project-docs/qa/environment-startup-guide.md
```
...
```bash
git add project-docs/qa/roadshow-demo-guide.md project-docs/qa/final-demo-handoff.md project-docs/qa/environment-startup-guide.md

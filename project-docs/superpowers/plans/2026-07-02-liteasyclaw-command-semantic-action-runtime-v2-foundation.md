...
This is the first implementation slice for `project-docs/superpowers/specs/2026-07-02-liteasyclaw-command-semantic-action-runtime-design.md`.
...
- `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`: add semantic action plan, runtime action invocation, risk, confidence, and plan preview event types.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/semanticPlanner.ts`: deterministic planner that maps natural-language command mode input to `SemanticActionPlan`.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/planExecutor.ts`: converts semantic plans to existing runtime events and executable action calls.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts`: call planner and executor instead of directly using phrase router for command mode.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/intentRouter.ts`: keep as compatibility helper only if still needed by tests, or reduce to wrapper over planner.
- `LiteasyClaw/desktop/src/app/features/skills/actionRegistry.ts`: leave unchanged in this foundation slice; layout/theme/panel semantics are represented as `action_request` events first, then wired to concrete AppShell actions in the next implementation slice.
- `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`: render plan preview runtime events as concise assistant messages.
- `LiteasyClaw/desktop/src/tests/agentRuntimeSemanticPlanner.test.ts`: planner behavior tests.
- `LiteasyClaw/desktop/src/tests/agentRuntimePlanExecutor.test.ts`: plan execution and policy tests.
- `LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts`: update command-mode integration coverage.
- `LiteasyClaw/desktop/src/tests/AssistantPane.test.tsx`: verify user-visible command mode feedback remains coherent.
...
Create `LiteasyClaw/desktop/src/tests/agentRuntimeSemanticPlanner.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeSemanticPlanner.test.ts
```
...
In `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`, add:
...
Create `LiteasyClaw/desktop/src/app/features/agent-runtime/semanticPlanner.ts`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts LiteasyClaw/desktop/src/app/features/agent-runtime/semanticPlanner.ts LiteasyClaw/desktop/src/tests/agentRuntimeSemanticPlanner.test.ts
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/agent-runtime/semanticPlanner.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimeSemanticPlanner.test.ts`
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime/semanticPlanner.ts LiteasyClaw/desktop/src/tests/agentRuntimeSemanticPlanner.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/agent-runtime/planExecutor.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimePlanExecutor.test.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts`

- [ ] **Step 1: Write failing plan executor tests**

Create `LiteasyClaw/desktop/src/tests/agentRuntimePlanExecutor.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimePlanExecutor.test.ts
```
...
Append to `LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeOrchestrator.test.ts src/tests/agentRuntimePlanExecutor.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime/planExecutor.ts LiteasyClaw/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts LiteasyClaw/desktop/src/tests/agentRuntimePlanExecutor.test.ts LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts
...
- Modify: `LiteasyClaw/desktop/src/app/features/agent-runtime/semanticPlanner.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts`
- Modify: `LiteasyClaw/desktop/src/tests/agentRuntimeSemanticPlanner.test.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeOrchestrator.test.ts src/tests/AssistantPane.test.tsx
```
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeSemanticPlanner.test.ts src/tests/agentRuntimePlanExecutor.test.ts src/tests/agentRuntimeOrchestrator.test.ts src/tests/AssistantPane.test.tsx
```
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeContextView.test.ts src/tests/AssistantContextPanel.test.tsx
```

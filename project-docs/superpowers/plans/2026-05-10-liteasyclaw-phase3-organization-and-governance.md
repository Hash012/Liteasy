...
- Depends on: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase2-sync-and-recommendation.md`
- Primary outcomes:
...
Phase 3 must stay grounded in `project-docs/LiteasyClaw_功能与UI设计文档1.0.md`, especially:
...
Status: **Phase 3 organization, governance, shared-library workspace, personal-center/profile, settings relocation, right-pane assistant boundary, and module-boundary hardening are implemented in the existing main working tree without committing. The remaining boundaries are productionization items documented in `project-docs/qa/phase3-governance-limitations.md`.**.
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/organization.types.ts`
- Create: `LiteasyClaw/desktop/src/app/features/organization/organizationSummaryClient.ts`
- Test: `LiteasyClaw/desktop/src/tests/organizationSummaryClient.test.ts`
...
Add `LiteasyClaw/desktop/src/tests/organizationSummaryClient.test.ts`:
...
Run: `cd LiteasyClaw/desktop && npm test -- src/tests/organizationSummaryClient.test.ts`

Expected: FAIL because `organizationSummaryClient` does not exist.

- [x] **Step 3: Add the cloud endpoint failing test**

Add a `returns a demo organization summary` test to `LiteasyClaw/services/dev-cloud/server.test.mjs` that posts `{ "sessionId": "demo-session-1" }` to `/v1/org/summary` and expects the same fields shown in Step 1.
...
Create the organization types and client, then add `buildOrganizationSummaryPayload()` plus a `POST /v1/org/summary` branch in `LiteasyClaw/services/dev-cloud/server.mjs`.
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/organizationSummaryClient.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSpacePanel.tsx`
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationSummary.ts`
...
Run: `cd LiteasyClaw/desktop && npm test -- src/tests/AppShell.test.tsx -t "shows organization space summary after cloud account login"`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/organization/organization.types.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/organizationSummaryClient.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSpacePanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/organizationSummaryClient.test.ts`
- Modify: `LiteasyClaw/services/dev-cloud/server.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/server.test.mjs`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/organizationSummaryClient.test.ts src/tests/AppShell.test.tsx -t "organization space summary|opens the organization shared library|posts a session id"
node --test LiteasyClaw/services/dev-cloud/server.test.mjs
```
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/organizationSummaryClient.test.ts src/tests/AppShell.test.tsx -t "members and notification|organization space summary|posts a session id"
```
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/organizationGovernanceClient.ts`
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationGovernance.ts`
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationGovernancePanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/organization.types.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Test: `LiteasyClaw/desktop/src/tests/organizationGovernanceClient.test.ts`
- Test: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `LiteasyClaw/services/dev-cloud/server.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/server.test.mjs`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/organizationGovernanceClient.test.ts src/tests/AppShell.test.tsx -t "governance summary"
node --test LiteasyClaw/services/dev-cloud/server.test.mjs
```
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/organizationListClient.ts`
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationList.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/organization.types.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/organizationSummaryClient.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationSummary.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSpacePanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Test: `LiteasyClaw/desktop/src/tests/organizationListClient.test.ts`
- Test: `LiteasyClaw/desktop/src/tests/organizationSummaryClient.test.ts`
- Test: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `LiteasyClaw/services/dev-cloud/server.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/server.test.mjs`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/organizationListClient.test.ts src/tests/organizationSummaryClient.test.ts src/tests/organizationGovernanceClient.test.ts src/tests/AppShell.test.tsx -t "organization|组织|governance|共享"
node --test --test-name-pattern "demo organization list|organization-specific governance|demo organization summary|demo organization governance" LiteasyClaw/services/dev-cloud/server.test.mjs
```
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/commandRouter.ts`
...
- Modify: `LiteasyClaw/desktop/src/app/features/skills/skillRegistry.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Test: `LiteasyClaw/desktop/src/tests/commandRouter.test.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/commandRouter.test.ts src/tests/actionRegistry.test.ts src/tests/AppShell.test.tsx -t "organization shared|打开组织共享|registered assistant command"
```
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationEntryDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Test: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/AppShell.test.tsx -t "organization|组织|governance|共享|entry dialog"
```
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Test: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/AppShell.test.tsx -t "personal center|organization entry dialog|organization|组织"
```
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/profile/AcademicArchiveDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Test: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/AppShell.test.tsx -t "personal center|academic archive|organization entry dialog|organization|组织"
```
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/profile/ClearProfileConfirmDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Test: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/AppShell.test.tsx -t "personal center|academic archive|clearing the user profile|organization entry dialog|organization|组织"
```
...
**Files:**
- Create: `project-docs/qa/phase3-test-guide.md`
- Create: `project-docs/qa/phase3-governance-limitations.md`
- Modify: `project-docs/qa/environment-startup-guide.md`
- Modify: `README.md`

- [x] **Step 1: Document the manual organization-space walkthrough**

Create `project-docs/qa/phase3-test-guide.md` with steps to start dev-cloud, start desktop, connect the demo cloud account, and verify the organization-space card fields.

- [x] **Step 2: Document governance limitations**

Create `project-docs/qa/phase3-governance-limitations.md` stating that organization membership, shared library browsing, quota, audit, and task visibility are demo seams without production auth or persistence.

- [x] **Step 3: Update startup and README references**

Add Phase 3 organization-space notes to `project-docs/qa/environment-startup-guide.md` and `README.md` without removing Phase 2 instructions.
...
```bash
test -f project-docs/qa/phase3-test-guide.md
test -f project-docs/qa/phase3-governance-limitations.md
rg "组织空间" README.md project-docs/qa/environment-startup-guide.md project-docs/qa/phase3-test-guide.md project-docs/qa/phase3-governance-limitations.md
```
...
**Files:**
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/organizationSummaryClient.test.ts src/tests/AppShell.test.tsx
node --test LiteasyClaw/services/dev-cloud/server.test.mjs
```
...
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/library/LibraryPane.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `LiteasyClaw/services/dev-cloud/server.mjs`
- Modify: `LiteasyClaw/services/dev-cloud/server.test.mjs`
- Modify: `project-docs/qa/phase3-test-guide.md`
- Modify: `project-docs/qa/phase3-governance-limitations.md`
- Modify: `project-docs/qa/environment-startup-guide.md`
- Modify: `README.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/organizationNotificationStorage.ts`
- Create: `LiteasyClaw/desktop/src/tests/organizationNotificationStorage.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/models/usePolicySync.ts`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/qa/phase3-test-guide.md`
- Modify: `project-docs/qa/phase3-governance-limitations.md`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/organization/organizationNotificationStorage.ts`
- Modify: `LiteasyClaw/desktop/src/tests/organizationNotificationStorage.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/qa/phase3-test-guide.md`
- Modify: `project-docs/qa/phase3-governance-limitations.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationInviteConfirmDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationLeaveConfirmDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/qa/phase3-test-guide.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationCreateDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/OrganizationJoinDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/qa/phase3-test-guide.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationActions.ts`
- Create: `LiteasyClaw/desktop/src/tests/useOrganizationActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationNotifications.ts`
- Create: `LiteasyClaw/desktop/src/tests/useOrganizationNotifications.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationWorkspace.ts`
- Create: `LiteasyClaw/desktop/src/tests/useOrganizationWorkspace.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/profile/useProfileActions.ts`
- Create: `LiteasyClaw/desktop/src/tests/useProfileActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/useLeftRailNavigation.ts`
- Create: `LiteasyClaw/desktop/src/tests/useLeftRailNavigation.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationUiState.ts`
- Create: `LiteasyClaw/desktop/src/tests/useOrganizationUiState.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationData.ts`
- Create: `LiteasyClaw/desktop/src/tests/useOrganizationData.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/collection/useCollectionItems.ts`
- Create: `LiteasyClaw/desktop/src/tests/useCollectionItems.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/models/useModelSettingsActions.ts`
- Create: `LiteasyClaw/desktop/src/tests/useModelSettingsActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/workspace/useWorkspaceActions.ts`
- Create: `LiteasyClaw/desktop/src/tests/useWorkspaceActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/artifacts/useArtifactActions.ts`
- Create: `LiteasyClaw/desktop/src/tests/useArtifactActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/workspace/useWorkspaceActions.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/workspace/useRegisteredWorkspaceActions.ts`
- Create: `LiteasyClaw/desktop/src/tests/useRegisteredWorkspaceActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/account/useCloudAccountActions.ts`
- Create: `LiteasyClaw/desktop/src/tests/useCloudAccountActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/starterPapers.ts`
- Create: `LiteasyClaw/desktop/src/app/features/workspace/workspaceStateHelpers.ts`
- Create: `LiteasyClaw/desktop/src/app/features/settings/settingsStateHelpers.ts`
- Create: `LiteasyClaw/desktop/src/tests/appShellStateHelpers.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/ActivityBar.tsx`
- Create: `LiteasyClaw/desktop/src/tests/ActivityBar.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `LiteasyClaw/desktop/src/tests/useWorkspaceActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/tests/useArtifactActions.test.ts`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/AppBrand.tsx`
- Create: `LiteasyClaw/desktop/src/tests/AppBrand.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/SettingsPane.tsx`
- Create: `LiteasyClaw/desktop/src/tests/SettingsPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/TopBar.tsx`
- Create: `LiteasyClaw/desktop/src/app/layout/LeftPane.tsx`
- Create: `LiteasyClaw/desktop/src/tests/TopBar.test.tsx`
- Create: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/AppDialogs.tsx`
- Create: `LiteasyClaw/desktop/src/tests/AppDialogs.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/network/cloudErrorMessage.ts`
- Create: `LiteasyClaw/desktop/src/tests/cloudErrorMessage.test.ts`
- Create: `LiteasyClaw/desktop/src/tests/useAccountSession.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/account/useAccountSession.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/models/usePolicySync.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/metadata/useDocumentMetadataSync.ts`
...
- Modify: `LiteasyClaw/desktop/src/tests/useOrganizationData.test.ts`
- Modify: `project-docs/qa/environment-startup-guide.md`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/LeftPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Modify: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/useAccountSession.test.ts`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/profile/useProfileActions.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/useProfileActions.test.ts`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/skills/actionRegistry.ts`
- Modify: `LiteasyClaw/desktop/src/tests/actionRegistry.test.ts`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `LiteasyClaw/desktop/src/tests/useOrganizationWorkspace.test.ts`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/commandRouter.ts`
- Modify: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/commandRouter.test.ts`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
- Modify: `LiteasyClaw/desktop/src/app/features/organization/organization.types.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationGovernance.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationGovernancePanel.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/useOrganizationData.test.ts`
- Modify: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/metadata/useDocumentMetadataSync.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/metadata/DocumentMetadataSyncPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/SettingsPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/LeftPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/SettingsPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/assistant.store.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Modify: `LiteasyClaw/desktop/src/tests/assistant.store.test.ts`
- Modify: `LiteasyClaw/desktop/src/tests/AssistantPane.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/profile/profile.types.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/useProfileActions.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/AcademicArchiveDialog.tsx`
...
- Modify: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppDialogs.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/ModeSwitch.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AssistantPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/library/LibraryPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/library/library.css`
- Modify: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/assistant/assistantSessionHistory.ts`
- Create: `LiteasyClaw/desktop/src/tests/assistantSessionHistory.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/workspace/workspaceFolderTree.ts`
- Create: `LiteasyClaw/desktop/src/tests/workspaceFolderTree.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/library/LibraryPane.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/profile/useAcademicProfileDraft.ts`
- Create: `LiteasyClaw/desktop/src/app/features/profile/AcademicProfileForm.tsx`
- Create: `LiteasyClaw/desktop/src/tests/useAcademicProfileDraft.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/PersonalCenterPanel.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/assistant/assistantPresentation.ts`
- Create: `LiteasyClaw/desktop/src/tests/assistantPresentation.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/ReaderPane.tsx`
- Create: `LiteasyClaw/desktop/src/tests/ReaderPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/AssistantSidebar.tsx`
- Create: `LiteasyClaw/desktop/src/tests/AssistantSidebar.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/layout/useAppShellStores.ts`
- Create: `LiteasyClaw/desktop/src/tests/useAppShellStores.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/assistant/AssistantHistoryPanel.tsx`
- Create: `LiteasyClaw/desktop/src/tests/AssistantHistoryPanel.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/assistant/AssistantMessageList.tsx`
- Create: `LiteasyClaw/desktop/src/tests/AssistantMessageList.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/assistant/AssistantComposer.tsx`
- Create: `LiteasyClaw/desktop/src/tests/AssistantComposer.test.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/library/libraryDragPayload.ts`
- Create: `LiteasyClaw/desktop/src/tests/libraryDragPayload.test.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/library/LibraryPane.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
Verified `cd LiteasyClaw/desktop && npm test` passes with 62 test files and 210 tests.

- [x] **Step 3: Run desktop production build**

Verified `cd LiteasyClaw/desktop && npm run build` passes through `tsc` and Vite production build.

- [x] **Step 4: Run dev-cloud tests**

Verified `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passes with 17 tests.
...
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppDialogs.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationEntryDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationCreateDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationJoinDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationInviteConfirmDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationLeaveConfirmDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/AcademicArchiveDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/features/profile/ClearProfileConfirmDialog.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Modify: `LiteasyClaw/desktop/src/tests/AppDialogs.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
Verified `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passes with 17 tests, and focused desktop recommendation/AppShell tests pass. Current live service on port 8787 must be restarted to pick up the fixed server code.
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/organization/useOrganizationActions.ts`
- Modify: `LiteasyClaw/desktop/src/app/features/organization/OrganizationSidebarPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/LeftPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/app/styles/app.css`
- Modify: `LiteasyClaw/desktop/src/tests/useOrganizationActions.test.ts`
- Modify: `LiteasyClaw/desktop/src/tests/LeftPane.test.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`
- Modify: `project-docs/superpowers/plans/2026-05-10-liteasyclaw-phase3-organization-and-governance.md`
...
Verified `cd LiteasyClaw/desktop && npm test -- src/tests/useOrganizationActions.test.ts src/tests/LeftPane.test.tsx src/tests/AppShell.test.tsx src/tests/AppDialogs.test.tsx` passes with 71 tests, `cd LiteasyClaw/desktop && npm run build` passes, full `cd LiteasyClaw/desktop && npm test` passes with 62 test files and 213 tests, and `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passes with 17 tests.
...
Added an AssistantPane regression proving a natural command alias is executed through the same command feedback path, then verified `cd LiteasyClaw/desktop && npm test -- src/tests/commandRouter.test.ts src/tests/AssistantPane.test.tsx src/tests/AppShell.test.tsx` passes with 80 tests and `cd LiteasyClaw/desktop && npm run build` passes.
...
Verified `cd LiteasyClaw/desktop && npm test -- src/tests/useOrganizationActions.test.ts src/tests/LeftPane.test.tsx src/tests/AppShell.test.tsx` passes with 67 tests and `cd LiteasyClaw/desktop && npm run build` passes.
...
**Files:**
- Add: `LiteasyClaw/desktop/src/app/features/models/DevCloudEndpointPanel.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/SettingsPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/LeftPane.tsx`
- Modify: `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`
- Modify: `LiteasyClaw/desktop/src/tests/SettingsPane.test.tsx`
...
Updated the Phase 3 test guide to explain the 8787/1420 distinction inside settings, then verified `cd LiteasyClaw/desktop && npm test -- src/tests/SettingsPane.test.tsx src/tests/LeftPane.test.tsx src/tests/useModelSettingsActions.test.ts src/tests/AppShell.test.tsx` passes with 69 tests and `cd LiteasyClaw/desktop && npm run build` passes.
...
Added an AssistantPane regression proving the command runs through the right-pane feedback flow, then verified `cd LiteasyClaw/desktop && npm test -- src/tests/commandRouter.test.ts src/tests/actionRegistry.test.ts src/tests/AssistantPane.test.tsx src/tests/AppShell.test.tsx` passes with 89 tests and `cd LiteasyClaw/desktop && npm run build` passes.
...
Verified `cd LiteasyClaw/desktop && npm test -- src/tests/LeftPane.test.tsx src/tests/useOrganizationWorkspace.test.ts src/tests/AppShell.test.tsx` passes with 71 tests and `cd LiteasyClaw/desktop && npm run build` passes.

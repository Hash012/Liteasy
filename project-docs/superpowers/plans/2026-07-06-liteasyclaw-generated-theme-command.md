...
- Create `LiteasyClaw/desktop/src/app/features/theme/generatedTheme.ts`: shared generated theme types, runtime validation, contrast helpers, CSS variable conversion.
- Modify `LiteasyClaw/desktop/src/app/features/skills/actionRegistry.ts`: add generated theme schema, action union, metadata, execution handler, and semantic signals.
- Modify `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`: add generated theme runtime action typing.
- Modify `LiteasyClaw/desktop/src/app/features/agent-runtime/modelSemanticPlanner.ts`: prompt the model to use `theme.apply_generated` for free-form visual commands and keep schema safety.
- Modify `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`: replace two-state runtime theme with typed runtime theme and apply generated CSS variables.
- Modify `LiteasyClaw/desktop/src/app/styles/app.css`: consume generated button and surface variables without disrupting existing layout.
- Test `LiteasyClaw/desktop/src/tests/generatedTheme.test.ts`: generated theme validator and CSS variable conversion.
- Test `LiteasyClaw/desktop/src/tests/actionRegistry.test.ts`: action metadata and execution.
- Test `LiteasyClaw/desktop/src/tests/modelSemanticPlanner.test.ts`: model-generated theme plan normalization and validation.
- Test `LiteasyClaw/desktop/src/tests/AppShell.test.tsx`: generated theme CSS variables and reset behavior.

## Task 1: Generated Theme Domain Module

**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/theme/generatedTheme.ts`
- Test: `LiteasyClaw/desktop/src/tests/generatedTheme.test.ts`
...
```bash
git add LiteasyClaw/desktop/src/app/features/theme/generatedTheme.ts \
  LiteasyClaw/desktop/src/app/features/skills/actionRegistry.ts \
  LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts \
  ...
  LiteasyClaw/desktop/src/app/styles/app.css \
  LiteasyClaw/desktop/src/tests/generatedTheme.test.ts \
  LiteasyClaw/desktop/src/tests/actionRegistry.test.ts \
  LiteasyClaw/desktop/src/tests/modelSemanticPlanner.test.ts \
  LiteasyClaw/desktop/src/tests/AppShell.test.tsx \
  project-docs/superpowers/plans/2026-07-06-liteasyclaw-generated-theme-command.md

...
**Architecture:** Keep the current desktop app as the customer endpoint and `LiteasyClaw/services/dev-cloud/server.mjs` as the server endpoint. Add a minimal internal operations console under `GET /admin/` plus JSON operations APIs under `/v1/admin/*`, using deterministic demo data already present in dev-cloud so no production database, auth, or deployment security is introduced yet.
...
- `LiteasyClaw/services/dev-cloud/server.mjs`: Owns local dev-cloud HTTP routes, admin HTML shell, and admin JSON payloads.
- `LiteasyClaw/services/dev-cloud/server.test.mjs`: Verifies operations routes, service index discoverability, and payload contracts.
- `project-docs/qa/phase4-three-end-demo-guide.md`: Explains how non-developers open the three endpoints and what to verify.
- `README.md`: Adds a short pointer from current effect-viewing instructions to the three-end demo guide.
- `project-docs/superpowers/plans/2026-05-15-liteasyclaw-phase4-three-end-demo.md`: Tracks implementation progress.
...
Add this test to `LiteasyClaw/services/dev-cloud/server.test.mjs` after the root index test:
...
In `LiteasyClaw/services/dev-cloud/server.mjs`, add a `writeHtml(request, response, statusCode, html)` helper next to `writeJson`, then add this route before the final method/path fallback:
...
Add `GET /v1/admin/governance-dashboard` to `LiteasyClaw/services/dev-cloud/server.mjs`. Return deterministic JSON:
...
**Files:**
- Create: `project-docs/qa/phase4-three-end-demo-guide.md`
- Modify: `README.md`

- [ ] **Step 1: Write tester guide**

Create `project-docs/qa/phase4-three-end-demo-guide.md` with these sections:
...
1. 启动开发云：`node /home/octopus/Liteasy/LiteasyClaw/services/dev-cloud/server.mjs`
2. 启动桌面前端：`cd /home/octopus/Liteasy/LiteasyClaw/desktop && npm run dev`
...
In `README.md`, add `project-docs/qa/phase4-three-end-demo-guide.md` under the QA guide list and mention `http://127.0.0.1:8787/admin/` in the effect-viewing section.
...
```bash
rg -n "127.0.0.1:1420|127.0.0.1:8787/admin|内部运营与运维后台 Demo" README.md project-docs/qa/phase4-three-end-demo-guide.md
```
...
**Files:**
- Modify: `project-docs/superpowers/plans/2026-05-15-liteasyclaw-phase4-three-end-demo.md`
...
- [x] `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passed with 19 server/provider tests.
- [x] `cd LiteasyClaw/desktop && npm test` passed with 62 desktop test files and 219 tests.
- [x] `cd LiteasyClaw/desktop && npm run build` passed through TypeScript and Vite production build.
...
- [x] `project-docs/qa/phase4-three-end-demo-guide.md` documents how to open the user desktop endpoint, dev-cloud endpoint, and operations endpoint.
...
- [x] Verification: `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passed with 20 server/provider tests.
- [x] Verification: `cd LiteasyClaw/desktop && npm test && npm run build` passed with 62 desktop test files, 219 desktop tests, and a successful production build.
...
- [x] Verification: `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passed with 21 server/provider tests.
- [x] Verification: `cd LiteasyClaw/desktop && npm test` passed with 63 desktop test files and 223 tests.
- [x] Verification: `cd LiteasyClaw/desktop && npm run build` passed through TypeScript and Vite production build.
...
- [x] Verification: `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passed with 21 server/provider tests after the role-boundary correction.
- [x] Verification: `cd LiteasyClaw/desktop && npm test && npm run build` passed with 63 desktop test files, 223 desktop tests, and a successful production build.
...
- [x] Verification: `node --test LiteasyClaw/services/dev-cloud/server.test.mjs LiteasyClaw/services/dev-cloud/providers/openaiResponses.test.mjs` passed with 22 server/provider tests.
- [x] Verification: `cd LiteasyClaw/desktop && npm test && npm run build` passed with 63 desktop test files, 223 desktop tests, and a successful production build.

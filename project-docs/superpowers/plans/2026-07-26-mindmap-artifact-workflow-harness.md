...
- Create `LiteasyClaw/desktop/src/app/features/artifact-workflow/mindmapArtifact.types.ts`
  - Owns `MindmapArtifact`, `MindmapNode`, source catalog, workflow plan, verification report, and workflow result types.
- Create `LiteasyClaw/desktop/src/app/features/artifact-workflow/mindmapArtifactVerifier.ts`
  - Owns deterministic validation: structure, source refs, paper coverage, external authority, and critical fact gates.
- Create `LiteasyClaw/desktop/src/app/features/artifact-workflow/externalKnowledgeProvider.ts`
  - Owns the pluggable external knowledge provider contract and first deterministic provider.
- Create `LiteasyClaw/desktop/src/app/features/artifact-workflow/mindmapWorkflowHarness.ts`
...
- Modify `LiteasyClaw/desktop/src/app/controllers/agent/createDesktopAgentService.ts`
...
- Modify focused tests under `LiteasyClaw/desktop/src/tests/`.

## Task 1: Mindmap Artifact Types

**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/artifact-workflow/mindmapArtifact.types.ts`
- Test: `LiteasyClaw/desktop/src/tests/mindmapArtifactVerifier.test.ts`

- [ ] **Step 1: Write the failing type-level behavior test**

Add this test scaffold to `LiteasyClaw/desktop/src/tests/mindmapArtifactVerifier.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/mindmapArtifactVerifier.test.ts
```
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/artifact-workflow/mindmapArtifactVerifier.ts`
- Test: `LiteasyClaw/desktop/src/tests/mindmapArtifactVerifier.test.ts`
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/artifact-workflow/externalKnowledgeProvider.ts`
- Test: `LiteasyClaw/desktop/src/tests/externalKnowledgeProvider.test.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/externalKnowledgeProvider.test.ts
```
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/artifact-workflow/mindmapWorkflowHarness.ts`
- Test: `LiteasyClaw/desktop/src/tests/mindmapWorkflowHarness.test.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/mindmapWorkflowHarness.test.ts
```
...
- Test: `LiteasyClaw/desktop/src/tests/multiPaperAnalysisWorkflow.test.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/generateAssistantAnswer.test.ts src/tests/multiPaperAnalysisWorkflow.test.ts
```
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/useArtifactActions.test.ts src/tests/useArtifactWorkflowController.test.ts
```
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/ArtifactTabs.test.tsx
```
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/controllers/agent/runAgentArtifactAnalysis.ts`
- Test: `LiteasyClaw/desktop/src/tests/runAgentArtifactAnalysis.test.ts`
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/runAgentArtifactAnalysis.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/artifact-workflow \
  LiteasyClaw/desktop/src/app/features/assistant/generateAssistantAnswer.ts \
  LiteasyClaw/desktop/src/app/controllers/agent/createDesktopAgentService.ts \
  LiteasyClaw/desktop/src/app/controllers/agent/runAgentArtifactAnalysis.ts \
  LiteasyClaw/desktop/src/app/features/artifacts \

...
- `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`: extend runtime contracts with runtime input, intent plan, action outcome metadata, and runtime execution context.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/intentRouter.ts`: map command-mode natural language to runtime plans for settings, organization, artifact, and unknown intents.
- `LiteasyClaw/desktop/src/tests/agentRuntimeIntentRouter.test.ts`: verify current command examples map to runtime plans and removed endpoint/model-policy commands remain unavailable.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/confirmationPolicy.ts`: classify planned actions as direct execution or confirmation-required.
- `LiteasyClaw/desktop/src/tests/agentRuntimeConfirmationPolicy.test.ts`: verify recommendation settings are direct and profile sampling requires confirmation.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/skillExecutor.ts`: execute planned skills through `executeSkill`, wrap success/failure into runtime events, and report settings mutation metadata.
- `LiteasyClaw/desktop/src/tests/agentRuntimeSkillExecutor.test.ts`: verify success, confirmation, and execution error event behavior.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts`: coordinate routing, artifact context checks, confirmation, execution, and event emission.
- `LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts`: verify unknown commands, direct settings execution, profile confirmation, and mind-map missing context behavior.
- `LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx`: replace direct `routeCommand` / `executeSkill` command-mode execution with `runAgentRuntime`.
- `LiteasyClaw/desktop/src/tests/AssistantPane.test.tsx`: verify command-mode UI renders runtime results and does not mutate profile sampling before confirmation.

## Task 1: Add Runtime Intent Routing

**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`
- Create: `LiteasyClaw/desktop/src/app/features/agent-runtime/intentRouter.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimeIntentRouter.test.ts`

- [ ] **Step 1: Write the failing intent-router test**

Create `LiteasyClaw/desktop/src/tests/agentRuntimeIntentRouter.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeIntentRouter.test.ts
```
...
Modify `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts` by adding these imports after the existing imports:
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts LiteasyClaw/desktop/src/app/features/agent-runtime/intentRouter.ts LiteasyClaw/desktop/src/tests/agentRuntimeIntentRouter.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/agent-runtime/confirmationPolicy.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimeConfirmationPolicy.test.ts`

- [ ] **Step 1: Write the failing confirmation-policy test**

Create `LiteasyClaw/desktop/src/tests/agentRuntimeConfirmationPolicy.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeConfirmationPolicy.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime/confirmationPolicy.ts LiteasyClaw/desktop/src/tests/agentRuntimeConfirmationPolicy.test.ts
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`
- Create: `LiteasyClaw/desktop/src/app/features/agent-runtime/skillExecutor.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimeSkillExecutor.test.ts`

- [ ] **Step 1: Write the failing skill-executor test**

Create `LiteasyClaw/desktop/src/tests/agentRuntimeSkillExecutor.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeSkillExecutor.test.ts
```
...
Modify `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts` by adding this type after `AgentRuntimeEvent`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts LiteasyClaw/desktop/src/app/features/agent-runtime/skillExecutor.ts LiteasyClaw/desktop/src/tests/agentRuntimeSkillExecutor.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts`

- [ ] **Step 1: Write the failing orchestrator test**

Create `LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime/runtimeOrchestrator.ts LiteasyClaw/desktop/src/tests/agentRuntimeOrchestrator.test.ts
...
Append this test to `LiteasyClaw/desktop/src/tests/AssistantPane.test.tsx`:

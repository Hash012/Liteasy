...
- `project-docs/engineering/module-boundaries.md`: documents module ownership, dependency rules, and test placement rules.
- `LiteasyClaw/desktop/src/app/features/selection/selection.types.ts`: defines selected-document-set snapshot types and validation result types.
- `LiteasyClaw/desktop/src/app/features/selection/selectionSnapshot.ts`: builds a selected-document-set snapshot from workspace state.
- `LiteasyClaw/desktop/src/app/features/selection/selectionValidation.ts`: validates selected-document-set readiness for agent and artifact flows.
- `LiteasyClaw/desktop/src/tests/selectionSnapshot.test.ts`: verifies selection snapshot construction.
- `LiteasyClaw/desktop/src/tests/selectionValidation.test.ts`: verifies missing, unlocked, and ready selection states.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`: defines runtime context, input, event, action request, task request, and artifact request contracts.
- `LiteasyClaw/desktop/src/app/features/agent-runtime/contextValidation.ts`: validates runtime context before command execution.
- `LiteasyClaw/desktop/src/tests/agentRuntimeContext.test.ts`: verifies context validation behavior.
- `LiteasyClaw/desktop/src/app/features/actions/action.types.ts`: defines action request/result contracts.
- `LiteasyClaw/desktop/src/app/features/actions/actionPolicy.ts`: adapts current resource action policy into the new action module.
- `LiteasyClaw/desktop/src/tests/actionPolicyAdapter.test.ts`: verifies action policy mapping.
- `LiteasyClaw/desktop/src/app/controllers/useWorkspaceSelectionController.ts`: wraps workspace and selection state for shell composition.
- `LiteasyClaw/desktop/src/tests/useWorkspaceSelectionController.test.ts`: verifies controller model construction.
- `LiteasyClaw/desktop/src/app/layout/AppShell.tsx`: consumes the new controller without changing visible behavior.

## Task 1: Add Module Boundary Documentation

**Files:**
- Create: `project-docs/engineering/module-boundaries.md`
...
```bash
mkdir -p project-docs/engineering
```
...
Create `project-docs/engineering/module-boundaries.md` with this content:
...
```bash
test -f project-docs/engineering/module-boundaries.md && rg -n "Selection Rule|Runtime Rule|AppShell Rule" project-docs/engineering/module-boundaries.md
```
...
```bash
git add project-docs/engineering/module-boundaries.md
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/selection/selection.types.ts`
- Create: `LiteasyClaw/desktop/src/app/features/selection/selectionSnapshot.ts`
- Test: `LiteasyClaw/desktop/src/tests/selectionSnapshot.test.ts`

- [ ] **Step 1: Write the failing snapshot test**

Create `LiteasyClaw/desktop/src/tests/selectionSnapshot.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/selectionSnapshot.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/selection LiteasyClaw/desktop/src/tests/selectionSnapshot.test.ts
...
**Files:**
- Modify: `LiteasyClaw/desktop/src/app/features/selection/selectionValidation.ts`
- Test: `LiteasyClaw/desktop/src/tests/selectionValidation.test.ts`

- [ ] **Step 1: Write the failing validation test**

Create `LiteasyClaw/desktop/src/tests/selectionValidation.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/selectionValidation.test.ts
```
...
Create `LiteasyClaw/desktop/src/app/features/selection/selectionValidation.ts`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/selection/selectionValidation.ts LiteasyClaw/desktop/src/tests/selectionValidation.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/agent-runtime/agentRuntime.types.ts`
- Create: `LiteasyClaw/desktop/src/app/features/agent-runtime/contextValidation.ts`
- Test: `LiteasyClaw/desktop/src/tests/agentRuntimeContext.test.ts`

- [ ] **Step 1: Write the failing runtime context test**

Create `LiteasyClaw/desktop/src/tests/agentRuntimeContext.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/agentRuntimeContext.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-runtime LiteasyClaw/desktop/src/tests/agentRuntimeContext.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/features/actions/action.types.ts`
- Create: `LiteasyClaw/desktop/src/app/features/actions/actionPolicy.ts`
- Test: `LiteasyClaw/desktop/src/tests/actionPolicyAdapter.test.ts`

- [ ] **Step 1: Write the failing action policy adapter test**

Create `LiteasyClaw/desktop/src/tests/actionPolicyAdapter.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/actionPolicyAdapter.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/features/actions LiteasyClaw/desktop/src/tests/actionPolicyAdapter.test.ts
...
**Files:**
- Create: `LiteasyClaw/desktop/src/app/controllers/useWorkspaceSelectionController.ts`
- Test: `LiteasyClaw/desktop/src/tests/useWorkspaceSelectionController.test.ts`

- [ ] **Step 1: Write the failing controller test**

Create `LiteasyClaw/desktop/src/tests/useWorkspaceSelectionController.test.ts`:
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/useWorkspaceSelectionController.test.ts
```
...
```bash
git add LiteasyClaw/desktop/src/app/controllers/useWorkspaceSelectionController.ts LiteasyClaw/desktop/src/tests/useWorkspaceSelectionController.test.ts
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/useWorkspaceSelectionController.test.ts src/tests/AppShell.test.tsx
```
...
Modify `LiteasyClaw/desktop/src/app/layout/AppShell.tsx` imports by adding:
...
```bash
git add LiteasyClaw/desktop/src/app/layout/AppShell.tsx LiteasyClaw/desktop/src/app/controllers/useWorkspaceSelectionController.ts LiteasyClaw/desktop/src/tests/useWorkspaceSelectionController.test.ts
...
```bash
rg -n "AppShell.test.tsx|模块级测试" README.md project-docs/engineering/module-boundaries.md
```
...
```bash
cd LiteasyClaw/desktop && npm test -- src/tests/selectionSnapshot.test.ts src/tests/selectionValidation.test.ts src/tests/agentRuntimeContext.test.ts src/tests/actionPolicyAdapter.test.ts src/tests/useWorkspaceSelectionController.test.ts
```

...
This Phase 1 plan implements the first hardening slice from `project-docs/engineering/agent-architecture-audit.md`:
...
- Create `LiteasyClaw/desktop/src/app/features/agent-core/capabilityAudit.ts`
...
- Modify `LiteasyClaw/desktop/src/app/features/agent-core/AgentSettingsPanel.tsx`
...
- Create `LiteasyClaw/desktop/src/app/features/assistant/agentEventPresenter.ts`
...
- Create `LiteasyClaw/desktop/src/app/features/retrieval/retrievalReadiness.ts`
  - Computes selected-paper evidence readiness before QA/artifact work.
- Create `LiteasyClaw/desktop/src/app/features/actions/highRiskActionAudit.ts`
  - Produces a tested audit list for high-risk actions that are intentionally blocked.
- Test `LiteasyClaw/desktop/src/tests/agentCapabilityAudit.test.ts`
- Test `LiteasyClaw/desktop/src/tests/SettingsPane.test.tsx`
- Test `LiteasyClaw/desktop/src/tests/agentEventPresenter.test.ts`
- Test `LiteasyClaw/desktop/src/tests/retrievalReadiness.test.ts`
- Test `LiteasyClaw/desktop/src/tests/highRiskActionAudit.test.ts`
...
Create `LiteasyClaw/desktop/src/tests/agentCapabilityAudit.test.ts`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/skills/skillRegistry.ts LiteasyClaw/desktop/src/app/features/agent-core/capabilityAudit.ts LiteasyClaw/desktop/src/tests/agentCapabilityAudit.test.ts
...
Modify `LiteasyClaw/desktop/src/tests/SettingsPane.test.tsx` inside the existing test after the assertion for `Skill 条目`:
...
Modify `LiteasyClaw/desktop/src/app/styles/app.css` after `.agent-settings-badge`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/agent-core/AgentSettingsPanel.tsx LiteasyClaw/desktop/src/app/styles/app.css LiteasyClaw/desktop/src/tests/SettingsPane.test.tsx
...
Create `LiteasyClaw/desktop/src/tests/agentEventPresenter.test.ts`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/assistant/agentEventPresenter.ts LiteasyClaw/desktop/src/app/features/assistant/AssistantPane.tsx LiteasyClaw/desktop/src/tests/agentEventPresenter.test.ts
...
Create `LiteasyClaw/desktop/src/tests/retrievalReadiness.test.ts`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/retrieval/retrievalReadiness.ts LiteasyClaw/desktop/src/tests/retrievalReadiness.test.ts
...
Create `LiteasyClaw/desktop/src/tests/highRiskActionAudit.test.ts`:
...
```bash
git add LiteasyClaw/desktop/src/app/features/actions/highRiskActionAudit.ts LiteasyClaw/desktop/src/tests/highRiskActionAudit.test.ts
...
**Files:**
- Modify: `project-docs/engineering/agent-architecture-audit.md`

- [ ] **Step 1: Add the Phase 1 tracking link**

Modify `project-docs/engineering/agent-architecture-audit.md` after the maturity marker section:
...
- `project-docs/superpowers/plans/2026-07-26-liteasyclaw-agent-architecture-hardening-phase1.md`
...
```bash
rg -n "Phase 1 Tracking|agent-architecture-hardening-phase1" project-docs/engineering/agent-architecture-audit.md
```
...
```bash
git add project-docs/engineering/agent-architecture-audit.md
